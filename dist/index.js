...
(() => {
  ...
  var init_Products = __esm({
    "src/mct/shared/types/api/Products.ts"() {
      ...
      SapValueENUM = /* @__PURE__ */ ((SapValueENUM4) => {
        SapValueENUM4[SapValueENUM4["Yes"] = 100] = "Yes";
        SapValueENUM4[SapValueENUM4["No"] = 80] = "No";
        return SapValueENUM4;
      })(SapValueENUM || {});
    }
  });
  ...
  var init_state = __esm({
    "src/mct/shared/types/state.ts"() {
      ...
      init_live_reload();
      init_api();
      CalculationKeysENUM = ((CalculationKeysENUM3) => {
        CalculationKeysENUM3["IsProceedable"] = "isProceedable";
        CalculationKeysENUM3["OfferAccepted"] = "offerAccepted";
        CalculationKeysENUM3["LTV"] = "LTV";
        CalculationKeysENUM3["MortgageAmount"] = "MortgageAmount";
        CalculationKeysENUM3[CalculationKeysENUM3["IncludeRetention"] = "IncludeRetention" /* IncludeRetention */] = "IncludeRetention";
        CalculationKeysENUM3["BorrowAmount"] = "BorrowAmount" /* BorrowAmount */;
        return CalculationKeysENUM3;
      })(CalculationKeysENUM || {});
    }
  });
  ...
  var generateProductsAPIInput = (options = {}) => {
    ...
    const SortColumn = filters.SortColumn ?? options.sortColumn ?? 1 /* Rate */;
    ...
    const NewBuild = SchemePurpose === 2 /* Remortgage */ ? void 0 : filters.NewBuild === "true" ? true : filters.NewBuild === "false" ? false : options.NewBuild ?? FILTERS_CONFIG.NewBuild === "true" ? true : false;
    const Features = {};
    if (options.HelpToBuy)
      Features.HelpToBuy = options.HelpToBuy;
    if (options.Offset)
      Features.Offset = options.Offset;
    if (options.EarlyRepaymentCharge)
      Features.EarlyRepaymentCharge = options.EarlyRepaymentCharge;
    if (NewBuild !== void 0)
      Features.NewBuild = NewBuild;
    const IncludeRetention = MCTManager.getCalculation(CalculationKeysENUM.IncludeRetention) ?? false;
    const input = {
      ...endOfAnswersInput,
      SapValue: 100,
      Features,
  ...
  var Result = class {
    ...
    populate() {
      this.outputs.forEach((output) => {
        ...
        if (outputName === "SAP") {
          outputValue = Number(outputValue) > 80 /* No */ ? true : false;
