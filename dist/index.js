...
(() => {
  ...
  var init_CreateLeadAndBooking = __esm({
    "src/mct/shared/types/api/CreateLeadAndBooking.ts"() {
      ...
      OfferAcceptedENUM = /* @__PURE__ */ ((OfferAcceptedENUM2) => {
        OfferAcceptedENUM2["Yes"] = "Y";
        OfferAcceptedENUM2["No"] = "N";
        return OfferAcceptedENUM2;
      })(OfferAcceptedENUM || {});
      ...
      PurchRemoENUM = /* @__PURE__ */ ((PurchRemoENUM2) => {
        PurchRemoENUM2["Purchase"] = "P";
        PurchRemoENUM2["Remortgage"] = "R";
        return PurchRemoENUM2;
      })(PurchRemoENUM || {});
  ...
  var PropertyTypeENUM, MortgageTypeENUM, SchemePurposeENUM, SchemePeriodsENUM, SchemeTypesENUM, SortColumnENUM, SapValueENUM;
  var init_Products = __esm({
    "src/mct/shared/types/api/Products.ts"() {
      "use strict";
      init_live_reload();
      PropertyTypeENUM = /* @__PURE__ */ ((PropertyTypeENUM2) => {
        PropertyTypeENUM2[PropertyTypeENUM2["House"] = 1] = "House";
        PropertyTypeENUM2[PropertyTypeENUM2["Flat"] = 2] = "Flat";
        return PropertyTypeENUM2;
      })(PropertyTypeENUM || {});
      MortgageTypeENUM = /* @__PURE__ */ ((MortgageTypeENUM2) => {
        MortgageTypeENUM2[MortgageTypeENUM2["Residential"] = 1] = "Residential";
        MortgageTypeENUM2[MortgageTypeENUM2["Btl"] = 2] = "Btl";
        return MortgageTypeENUM2;
      })(MortgageTypeENUM || {});
      SchemePurposeENUM = /* @__PURE__ */ ((SchemePurposeENUM2) => {
        SchemePurposeENUM2[SchemePurposeENUM2["Purchase"] = 1] = "Purchase";
        SchemePurposeENUM2[SchemePurposeENUM2["Remortgage"] = 2] = "Remortgage";
        return SchemePurposeENUM2;
      })(SchemePurposeENUM || {});
      SchemePeriodsENUM = /* @__PURE__ */ ((SchemePeriodsENUM2) => {
        SchemePeriodsENUM2[SchemePeriodsENUM2["TwoYears"] = 1] = "TwoYears";
        SchemePeriodsENUM2[SchemePeriodsENUM2["ThreeYears"] = 2] = "ThreeYears";
        SchemePeriodsENUM2[SchemePeriodsENUM2["FiveYears"] = 3] = "FiveYears";
        SchemePeriodsENUM2[SchemePeriodsENUM2["FivePlusYears"] = 4] = "FivePlusYears";
        return SchemePeriodsENUM2;
      })(SchemePeriodsENUM || {});
      SchemeTypesENUM = /* @__PURE__ */ ((SchemeTypesENUM2) => {
        SchemeTypesENUM2[SchemeTypesENUM2["Fixed"] = 1] = "Fixed";
        SchemeTypesENUM2[SchemeTypesENUM2["Variable"] = 2] = "Variable";
        return SchemeTypesENUM2;
      })(SchemeTypesENUM || {});
      SortColumnENUM = /* @__PURE__ */ ((SortColumnENUM2) => {
        SortColumnENUM2[SortColumnENUM2["Rate"] = 1] = "Rate";
        SortColumnENUM2[SortColumnENUM2["AverageAnnualCost"] = 2] = "AverageAnnualCost";
        SortColumnENUM2[SortColumnENUM2["MaxLTV"] = 3] = "MaxLTV";
        SortColumnENUM2[SortColumnENUM2["MonthlyPayment"] = 4] = "MonthlyPayment";
        SortColumnENUM2[SortColumnENUM2["Lender"] = 5] = "Lender";
        SortColumnENUM2[SortColumnENUM2["Fees"] = 6] = "Fees";
        return SortColumnENUM2;
      })(SortColumnENUM || {});
  ...
  var generateProductsAPIInput = (options = {}) => {
    ...
    const RepaymentValue = answers.RepaymentValue ?? PropertyValue - DepositAmount;
    const PropertyType = PropertyTypeENUM[answers.PropertyType] ?? 1 /* House */;
    const MortgageType = MortgageTypeENUM[answers.ResiBtl];
    const InterestOnlyValue = answers.InterestOnlyValue ?? 0;
    const TermYears = answers.MortgageLength;
    const SchemePurpose = SchemePurposeENUM[answers.PurchRemo];
    const SchemePeriodsValue = answers.SchemePeriods;
    const SchemePeriods = [SchemePeriodsENUM[SchemePeriodsValue]];
    const SchemeTypesValue = answers.SchemeTypes;
    const SchemeTypes = SchemeTypesValue.map((type) => SchemeTypesENUM[type]);
    ...
    const NewBuild = answers.NewBuild === "true" ? true : answers.NewBuild === "false" ? false : options.NewBuild ? options.NewBuild : FILTERS_CONFIG.NewBuild === "true" ? true : false;
    const SapValue = answers.SapValue ? SapValueENUM[answers.SapValue] : options.SapValue ? options.SapValue : FILTERS_CONFIG.SapValue === getEnumKey(SapValueENUM, 1 /* No */) ? 1 /* No */ : 81 /* Yes */;
    const IncludeRetention = calculations.IncludeRetention ?? false;
  ...
  var getValueAsLandC = (key) => {
    ...
    switch (key) {
      case "CreditImpaired":
        return CreditImpairedENUM[value];
      case "EndOfTerm":
        return EndOfTermENUM[value];
      case "FTB":
        return FirstTimeBuyerENUM[value];
      case "MortgageType":
        return MortgageTypeENUM[value];
      case "PropertyType":
        return PropertyTypeENUM[value];
      case "PurchRemo":
        return PurchRemoENUM[value];
      case "ReadinessToBuy":
        return ReadinessToBuyENUM[value];
      case "RemoChange":
        return RemoChangeENUM[value];
      case "RepaymentType":
        return RepaymentTypeENUM[value];
      case "ResiBtl":
        return ResiBtlENUM[value];
      case "SapValue":
        return SapValueENUM[value];
      case "SchemePeriods":
        return SchemePeriodsENUM[value];
      case "SchemeTypes":
        return value.map((v) => SchemeTypesENUM[v]);
      case "SchemePurpose":
        return SchemePurposeENUM[value];
      case "SortColumn":
        return SortColumnENUM[value];
      default:
        return value;
    }
  };
  ...
  var StatefulInputGroup = class extends StatefulComponent {
    ...
    handleChange() {
      ...
      this.onChange();
      this.emit("input:changed" /* INPUT_CHANGED */, {
        value,
        isValid,
    ...
    handleEnter(event) {
      ...
      if (!isValid)
        return;
      this.onEnter();
      this.emit("input:on-enter" /* INPUT_ON_ENTER */, {
        value,
        isValid,
        type: this.getStateValue("type"),
        groupName: this.getStateValue("groupName"),
  ...
  var ResultsManager = class {
    constructor(component) {
      ...
      this.appointmentDialogButton = queryElement(
        `[${attr11.components}="book-an-appointment"]`,
        this.header
      );
      this.appointmentDialog = queryElement(
        `[${attr11.components}="appointment-dialog"]`,
        this.component
      );
      this.appointmentDialogClose = queryElement(
        `[${attr11.components}="close-appointment-dialog"]`,
        this.appointmentDialog
      );
      this.getFreeAdvice = queryElement(`[${attr11.components}="get-free-advice"]`, this.appointmentDialog);
      this.getFreeAdviceButton = queryElement("button", this.getFreeAdvice);
      this.getADecision = queryElement(`[${attr11.components}="get-a-decision"]`, this.appointmentDialog);
      this.getADecisionButtons = [
        queryElement("button", this.getADecision),
        queryElement(`[${attr11.components}="get-a-decision-button"]`, this.header)
      ];
      this.applyDirect = queryElement(
        `[${attr11.components}="apply-direct"]`,
        this.appointmentDialog
      );
      if (this.applyDirect)
        this.applyDirectLink = queryElement("a", this.applyDirect);
      if (this.applyDirect)
    ...
    initAppointmentDialog() {
      ...
      this.appointmentDialogButton.addEventListener("click", () => MCTManager.goToStage("appointment" /* Appointment */));
    ...
    renderOutputs() {
      ...
      this.outputs.forEach((output) => {
        ...
        if (key === "LTV") {
          const propertyValue = MCTManager.getAnswer("PropertyValue");
          const depositAmount = MCTManager.getAnswer("DepositAmount");
    ...
    getStateData() {
      try {
        ...
        const stateData = {
          ...
          RepaymentType: RepaymentTypeENUM[this.getStringAnswer(answers, "RepaymentType")],
          OfferAccepted: OfferAcceptedENUM[this.getStringAnswer(answers, "OfferAccepted")],
          MortgageLength: this.getNumericAnswer(answers, "MortgageLength"),
          MaximumBudget: this.getNumericAnswer(answers, "MaximumBudget"),
          // unsure
          BuyerType: BuyerTypeENUM2[this.getStringAnswer(answers, "BuyerType")],
          // unsure
          ResiBtl: ResiBtlENUM[this.getStringAnswer(answers, "ResiBtl")],
          Lender: this.getStringAnswer(answers, "Lender"),
          ReadinessToBuy: ReadinessToBuyENUM[this.getStringAnswer(answers, "ReadinessToBuy")],
          PurchRemo: PurchRemoENUM[this.getStringAnswer(answers, "PurchRemo")],
          ...
          // unsure
          CreditImpaired: CreditImpairedENUM[this.getStringAnswer(answers, "CreditImpaired")]
        };
        return stateData;
      } catch (error) {
  ...
  var CalculationManager = class {
    constructor(stateManager2) {
      this.calculateReadinessToBuyCalculations = (answers) => {
        console.log("\u{1F504} calculateReadinessToBuyCalculations");
        const isProceedable = this.calculateIsProceedable(answers);
        console.log("\u{1F504} isProceedable", isProceedable);
        const offerAccepted = this.calculateOfferAccepted(answers);
        console.log("\u{1F504} offerAccepted", offerAccepted);
        return { ...isProceedable, ...offerAccepted };
      };
      this.calculateIsProceedable = (answers) => {
        console.log("\u{1F504} calculateIsProceedable");
        const { ReadinessToBuy, CreditImpaired, EndOfTerm } = answers;
        if (!ReadinessToBuy && !CreditImpaired && !EndOfTerm)
          return {};
        let isProceedable = false;
        if (ReadinessToBuy && CreditImpaired) {
          const readinessToBuyValue = ReadinessToBuyENUM[ReadinessToBuy];
          const readinessToBuyProceedable = readinessToBuyValue === "M" /* MadeAnOffer */ || readinessToBuyValue === "A" /* OfferAccepted */;
          const creditImpairedValue = CreditImpairedENUM[CreditImpaired];
          const creditImpairedProceedable = creditImpairedValue === "N" /* No */;
          isProceedable = readinessToBuyProceedable && creditImpairedProceedable;
        } else if (EndOfTerm) {
          const endOfTermValue = EndOfTermENUM[EndOfTerm];
          const endOfTermProceedable = endOfTermValue === "1" /* WithinThreeMonths */ || endOfTermValue === "2" /* ThreeToSixMonths */;
      ...
      this.calculateOfferAccepted = (answers) => {
        console.log("\u{1F504} calculateOfferAccepted");
      ...
      this.calculateIncludeRetention = (answers) => {
        ...
        if (!RemoChange)
          return {};
        const remoChangeValue = RemoChangeENUM[RemoChange];
    ...
    subscribeToStateChanges() {
      this.stateManager.subscribe((event) => {
        if (event.changes.answers)
          this.runCalculations(event.currentState.answers);
      });
    }
