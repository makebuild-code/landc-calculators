...
(() => {
  ...
  var init_Products = __esm({
    "src/mct/shared/types/api/Products.ts"() {
      ...
      SapValueENUM = /* @__PURE__ */ ((SapValueENUM3) => {
        ...
        SapValueENUM3[SapValueENUM3["No"] = 80] = "No";
  ...
  var init_generateProductsAPIInput = __esm({
    "src/mct/shared/utils/common/generateProductsAPIInput.ts"() {
      ...
      generateProductsAPIInput = (options = {}) => {
        ...
        const miscValues = currentStage === "questions" /* Questions */ ? { ...filters, ...options } : { ...options, ...filters };
        const SortColumn = miscValues.SortColumn ?? 1 /* Rate */;
        ...
        const NewBuild = SchemePurpose === 2 /* Remortgage */ ? void 0 : miscValues.NewBuild === "true" ? true : miscValues.NewBuild === "false" ? false : FILTERS_CONFIG.NewBuild === "true" ? true : false;
        const Features = {};
        if (miscValues.Offset)
          Features.Offset = miscValues.Offset;
        if (miscValues.EarlyRepaymentCharge)
          Features.EarlyRepaymentCharge = miscValues.EarlyRepaymentCharge;
        if (NewBuild !== void 0)
          Features.NewBuild = NewBuild;
  ...
  var init_filters = __esm({
    "src/mct/shared/config/filters.ts"() {
      ...
      FILTERS_CONFIG = {
        NewBuild: "false",
        SapValue: getEnumKey(SapValueENUM, 80 /* No */),
      ...
      Result = class {
        ...
        populate() {
          this.outputs.forEach((output) => {
            ...
            if (outputName === "SAP") {
              outputShow = Number(outputValue) > 80 /* No */ ? true : false;
      ...
      AppointmentManager = class {
        ...
        createRemortgageEnquiry(state, answers, calculations) {
          return {
            ...
            CurrentLender: this.getStringAnswer(answers, "Lender" /* Lender */)
          };
        }
        /**
  ...
  var VERSION, attr15, eventBus, numberOfStagesShown, stageManagers, dom, stateManager, calculationManager, visibilityManager, questionRegistry, MCTManager;
  var init_MCTManager = __esm({
    "src/mct/shared/MCTManager.ts"() {
      ...
      init_dataLayer();
      init_debug();
      VERSION = "\u{1F504} MCT DIST v34";
      attr15 = DOM_CONFIG.attributes;
      eventBus = EventBus.getInstance();
      numberOfStagesShown = 0;
      stageManagers = {};
      dom = {
        component: null,
        stages: {}
      ...
      MCTManager = {
        ...
        route() {
          ...
          if (numberOfStages === 0) {
            debugError("\u{1F504} No stage managers initialised");
            return;
          ...
          eventBus.on("mct:stage:complete" /* STAGE_COMPLETE */, (event) => {
            ...
            switch (event.stageId) {
              ...
              case "results" /* Results */:
                ...
                nextStageId = "appointment" /* Appointment */;
                break;
              default:
                nextStageId = null;
            }
            if (nextStageId)
              this.goToStage(nextStageId);
          });
        },
        goToStage(stageId, options = {}) {
          ...
          const currentStage = stageManagers[currentStageId] ?? null;
          if (currentStage)
            currentStage.hide();
