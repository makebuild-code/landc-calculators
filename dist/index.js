...
(() => {
  ...
  var queryElements;
  var init_queryelements = __esm({
    "src/utils/dom/queryelements.ts"() {
      "use strict";
      init_live_reload();
      queryElements = (query2, parent = document) => {
        const elements2 = parent.querySelectorAll(query2);
        return elements2.length ? [...elements2] : [];
      };
    }
  });

  // src/utils/environment/getEnvironment.ts
  var getEnvironment;
  var init_getEnvironment = __esm({
    "src/utils/environment/getEnvironment.ts"() {
      "use strict";
      init_live_reload();
      getEnvironment = () => {
  ...
  var init_getBaseURLForAPI = __esm({
    "src/utils/environment/getBaseURLForAPI.ts"() {
      "use strict";
      init_live_reload();
      init_getEnvironment();
  ...
  var isStaging;
  var init_isStaging = __esm({
    "src/utils/environment/isStaging.ts"() {
      "use strict";
      init_live_reload();
      isStaging = !window.location.host.includes("www.landc.co.uk");
    }
  });

  // src/utils/formatting/numberToCurrency.ts
  var numberToCurrency;
  var init_numberToCurrency = __esm({
    "src/utils/formatting/numberToCurrency.ts"() {
      "use strict";
      init_live_reload();
  ...
  var queryElement;
  var init_queryElement = __esm({
    "src/utils/dom/queryElement.ts"() {
      "use strict";
      init_live_reload();
      queryElement = (query2, parent = document) => {
  ...
  var init_setSearchParameter = __esm({
    "src/utils/storage/setSearchParameter.ts"() {
      "use strict";
      init_live_reload();
      setSearchParameter = (element, paramsToAdd) => {
  ...
  var init_dialogs = __esm({
    "src/components/dialogs.ts"() {
      ...
      init_queryElement();
      init_queryelements();
      dialogs = (component = document.body) => {
        const attr16 = "data-dialog";
        const components2 = queryElements(`[${attr16}="component"]`);
        components2.forEach((component2) => {
          const open = queryElement(`[${attr16}="open"]`, component2);
          const dialog = queryElement("dialog", component2);
          const close = queryElement(`[${attr16}="close"]`, component2);
  ...
  function checkInputValidity(input) {
    ...
    if (input instanceof HTMLInputElement) {
      ...
      switch (type) {
        case "number":
          const { min: min2, max: max2 } = input;
          let minValid = true;
          if (!!min2)
            minValid = Number(value) >= Number(min2);
          let maxValid = true;
          if (!!max2)
            maxValid = Number(value) <= Number(max2);
          isValid = minValid && maxValid;
          if (isValid)
            break;
          error = !minValid ? `Input needs to be ${min2} or higher` : `Input needs to be ${max2} or less`;
          break;
        default:
  ...
  var init_checkInputValidity = __esm({
    "src/utils/input/checkInputValidity.ts"() {
      "use strict";
      init_live_reload();
    }
  ...
  // src/utils/input/clearInput.ts
  var init_clearInput = __esm({
    "src/utils/input/clearInput.ts"() {
      "use strict";
      init_live_reload();
    }
  ...
  function getWrapper(input) {
    let child2 = input, wrapper;
    while (child2) {
      if (child2.parentElement && child2.parentElement.classList && child2.parentElement.classList.contains("custom-field_component")) {
        wrapper = child2.parentElement;
        break;
      } else if (child2.parentElement) {
  ...
  var init_handleConditionalVisibility = __esm({
    "src/utils/dom/handleConditionalVisibility.ts"() {
      "use strict";
      init_live_reload();
      init_dom();
  ...
  var init_dom = __esm({
    "src/utils/dom/index.ts"() {
      ...
      init_createElement();
      init_getWrapper();
      init_handleConditionalVisibility();
      init_queryElement();
      init_queryelements();
    }
  });
  ...
  var handleEnterInInputs;
  var init_handleEnterInInputs = __esm({
    "src/utils/input/handleEnterInInputs.ts"() {
      "use strict";
      init_live_reload();
      handleEnterInInputs = (input, callback2) => {
  ...
  function syncSlider(inputId, initialValue) {
    ...
    const updateSliderUI = () => {
      ...
      if (isNaN(value))
        return;
      const min2 = parseFloat(input.min || handle.getAttribute("aria-valuemin") || "0");
      const max2 = parseFloat(input.max || handle.getAttribute("aria-valuemax") || "100");
      const clamped = Math.min(Math.max(value, min2), max2);
      const percent = (clamped - min2) / (max2 - min2) * 100;
  ...
  var init_input = __esm({
    "src/utils/input/index.ts"() {
      "use strict";
      init_live_reload();
      init_checkInputValidity();
      init_clearInput();
      init_formatInput();
      init_getInputValue();
      init_handleEnterInInputs();
      init_setError();
      init_syncSlider();
    }
  });
  ...
  // src/utils/formatting/getOrdinalDate.ts
  var getOrginalDate, getOrdinalSuffix;
  var init_getOrdinalDate = __esm({
    "src/utils/formatting/getOrdinalDate.ts"() {
      "use strict";
      init_live_reload();
      getOrginalDate = (date) => {
  ...
  var init_formatting = __esm({
    "src/utils/formatting/index.ts"() {
      ...
      init_formatNumber();
      init_getOrdinalDate();
      init_numberToCurrency();
    }
  });

  // src/utils/storage/getFromCookie.ts
  var getFromCookie;
  var init_getFromCookie = __esm({
    "src/utils/storage/getFromCookie.ts"() {
      "use strict";
      init_live_reload();
      getFromCookie = (key) => {
  ...
  var init_storage = __esm({
    "src/utils/storage/index.ts"() {
      ...
      init_live_reload();
      init_getFromCookie();
      init_setSearchParameter();
      init_setToCookie();
    }
  });

  // src/mct/shared/config/api.ts
  var API_CONFIG;
  var init_api = __esm({
    "src/mct/shared/config/api.ts"() {
      "use strict";
  ...
  // src/mct/shared/config/components.ts
  ...
  // src/mct/shared/types/api/base.ts
  var DatePlanToRemoENUM, RemoChangeENUM;
  var init_base = __esm({
    "src/mct/shared/types/api/base.ts"() {
      "use strict";
      init_live_reload();
      DatePlanToRemoENUM = /* @__PURE__ */ ((DatePlanToRemoENUM3) => {
        DatePlanToRemoENUM3["WithinThreeMonths"] = "0-3 months";
        DatePlanToRemoENUM3["ThreeToSixMonths"] = "3-6 months";
        DatePlanToRemoENUM3["SixToTwelveMonths"] = "6-12 months";
        DatePlanToRemoENUM3["TwelvePlusMonths"] = "Over 12 months";
        return DatePlanToRemoENUM3;
      })(DatePlanToRemoENUM || {});
      RemoChangeENUM = /* @__PURE__ */ ((RemoChangeENUM2) => {
        RemoChangeENUM2[RemoChangeENUM2["NoChange"] = 1] = "NoChange";
        RemoChangeENUM2[RemoChangeENUM2["BorrowMore"] = 2] = "BorrowMore";
        RemoChangeENUM2[RemoChangeENUM2["BorrowLess"] = 3] = "BorrowLess";
        RemoChangeENUM2[RemoChangeENUM2["TermAndOrRepaymentType"] = 4] = "TermAndOrRepaymentType";
        return RemoChangeENUM2;
      })(RemoChangeENUM || {});
    }
  });

  // src/mct/shared/types/api/CreateLeadAndBooking.ts
  var FirstTimeBuyerENUM, RepaymentTypeENUM, ResiBtlENUM, ReadinessToBuyENUM, PurchRemoENUM, CreditImpairedENUM, FTBENUM, NewBuildENUM;
  var init_CreateLeadAndBooking = __esm({
    "src/mct/shared/types/api/CreateLeadAndBooking.ts"() {
      "use strict";
      init_live_reload();
      init_types();
      init_base();
      FirstTimeBuyerENUM = /* @__PURE__ */ ((FirstTimeBuyerENUM2) => {
        FirstTimeBuyerENUM2["Yes"] = "Y";
        FirstTimeBuyerENUM2["No"] = "N";
        return FirstTimeBuyerENUM2;
      })(FirstTimeBuyerENUM || {});
      RepaymentTypeENUM = /* @__PURE__ */ ((RepaymentTypeENUM2) => {
        RepaymentTypeENUM2["Repayment"] = "Repayment";
        RepaymentTypeENUM2["InterestOnly"] = "Interest Only";
        RepaymentTypeENUM2["Both"] = "Both";
        return RepaymentTypeENUM2;
      })(RepaymentTypeENUM || {});
      ResiBtlENUM = /* @__PURE__ */ ((ResiBtlENUM2) => {
        ResiBtlENUM2["Residential"] = "R";
        ResiBtlENUM2["Btl"] = "B";
        return ResiBtlENUM2;
      })(ResiBtlENUM || {});
      ReadinessToBuyENUM = /* @__PURE__ */ ((ReadinessToBuyENUM2) => {
        ReadinessToBuyENUM2["Researching"] = "R";
        ReadinessToBuyENUM2["Viewing"] = "V";
        ReadinessToBuyENUM2["MadeAnOffer"] = "M";
        ReadinessToBuyENUM2["OfferAccepted"] = "A";
        return ReadinessToBuyENUM2;
      })(ReadinessToBuyENUM || {});
      PurchRemoENUM = /* @__PURE__ */ ((PurchRemoENUM4) => {
        PurchRemoENUM4["Purchase"] = "P";
        PurchRemoENUM4["Remortgage"] = "R";
        return PurchRemoENUM4;
      })(PurchRemoENUM || {});
      CreditImpairedENUM = /* @__PURE__ */ ((CreditImpairedENUM2) => {
        CreditImpairedENUM2["Yes"] = "Y";
        CreditImpairedENUM2["No"] = "N";
        return CreditImpairedENUM2;
      })(CreditImpairedENUM || {});
      FTBENUM = /* @__PURE__ */ ((FTBENUM2) => {
        FTBENUM2["Yes"] = "Y";
        FTBENUM2["No"] = "N";
        return FTBENUM2;
      })(FTBENUM || {});
      NewBuildENUM = /* @__PURE__ */ ((NewBuildENUM2) => {
        NewBuildENUM2["Yes"] = "Y";
        NewBuildENUM2["No"] = "N";
        return NewBuildENUM2;
      })(NewBuildENUM || {});
    }
  });

  // src/mct/shared/types/api/Lenders.ts
  ...
  // src/mct/shared/types/api/LogUserEvents.ts
  var init_LogUserEvents = __esm({
    "src/mct/shared/types/api/LogUserEvents.ts"() {
      "use strict";
      init_live_reload();
    }
  ...
  // src/mct/shared/types/api/MortgageAppointmentSlots.ts
  var init_MortgageAppointmentSlots = __esm({
    "src/mct/shared/types/api/MortgageAppointmentSlots.ts"() {
      "use strict";
      init_live_reload();
    }
  ...
  // src/mct/shared/types/api/Products.ts
  var SchemePeriodsENUM, SchemeTypesENUM, SapValueENUM;
  var init_Products = __esm({
    "src/mct/shared/types/api/Products.ts"() {
      "use strict";
      init_live_reload();
      SchemePeriodsENUM = /* @__PURE__ */ ((SchemePeriodsENUM3) => {
        SchemePeriodsENUM3["TwoYears"] = "[1]";
        SchemePeriodsENUM3["ThreeYears"] = "[2]";
        SchemePeriodsENUM3["FiveYears"] = "[3]";
        SchemePeriodsENUM3["FivePlusYears"] = "[4]";
        SchemePeriodsENUM3["All"] = "[1, 2, 3, 4]";
        return SchemePeriodsENUM3;
      })(SchemePeriodsENUM || {});
      SchemeTypesENUM = /* @__PURE__ */ ((SchemeTypesENUM3) => {
        SchemeTypesENUM3["Fixed"] = "[1]";
        SchemeTypesENUM3["Variable"] = "[2]";
        SchemeTypesENUM3["All"] = "[1, 2]";
        return SchemeTypesENUM3;
      })(SchemeTypesENUM || {});
      SapValueENUM = /* @__PURE__ */ ((SapValueENUM3) => {
        SapValueENUM3[SapValueENUM3["Yes"] = 100] = "Yes";
        SapValueENUM3[SapValueENUM3["No"] = 69] = "No";
        return SapValueENUM3;
      })(SapValueENUM || {});
    }
  });

  // src/mct/shared/types/api/index.ts
  var init_api2 = __esm({
    "src/mct/shared/types/api/index.ts"() {
      "use strict";
      init_live_reload();
      init_base();
      init_CreateLeadAndBooking();
      init_Lenders();
      init_LogUserEvents();
      init_MortgageAppointmentSlots();
      init_Products();
    }
  });

  // src/mct/shared/types/common.ts
  ...
  // src/mct/shared/types/config.ts
  ...
  // src/mct/shared/types/events.ts
  ...
  // src/mct/shared/types/stages.ts
  var StageIDENUM;
  var init_stages = __esm({
    "src/mct/shared/types/stages.ts"() {
      ...
      init_live_reload();
      init_common();
      StageIDENUM = /* @__PURE__ */ ((StageIDENUM3) => {
        StageIDENUM3["Questions"] = "questions";
        StageIDENUM3["Results"] = "results";
        StageIDENUM3["Appointment"] = "appointment";
        return StageIDENUM3;
      })(StageIDENUM || {});
    }
  });

  // src/mct/shared/types/state.ts
  var CalculationKeysENUM;
  var init_state = __esm({
    "src/mct/shared/types/state.ts"() {
      "use strict";
      init_live_reload();
      init_api2();
      CalculationKeysENUM = ((CalculationKeysENUM2) => {
        CalculationKeysENUM2["BuyerType"] = "BuyerType";
        CalculationKeysENUM2["LTV"] = "LTV";
        CalculationKeysENUM2[CalculationKeysENUM2["IncludeRetention"] = "IncludeRetention" /* IncludeRetention */] = "IncludeRetention";
        CalculationKeysENUM2["IsProceedable"] = "isProceedable";
        CalculationKeysENUM2["MortgageAmount"] = "MortgageAmount";
        CalculationKeysENUM2["OfferAccepted"] = "offerAccepted";
        return CalculationKeysENUM2;
      })(CalculationKeysENUM || {});
    }
  });

  // src/mct/shared/types/index.ts
  ...
  var generateProductsAPIInput;
  var init_generateProductsAPIInput = __esm({
    "src/mct/shared/utils/common/generateProductsAPIInput.ts"() {
      "use strict";
      init_live_reload();
      init_config2();
      ...
      generateProductsAPIInput = (options = {}) => {
        ...
        const answers = PurchRemo === "P" /* Purchase */ ? MCTManager.getAnswers() : PurchRemo === "R" /* Remortgage */ ? MCTManager.getAnswers() : null;
        if (!answers)
          return null;
        const { PropertyValue, ResiBtl, MortgageLength, RepaymentType, FTB } = answers;
        const ShowFTB = FTB === getEnumKey(FirstTimeBuyerENUM, "Y" /* Yes */) ? true : false;
        let InterestOnlyValue = answers["InterestOnlyValue" /* InterestOnlyValue */] ?? 0;
        let RepaymentValue = 0;
        if (PurchRemo === "P" /* Purchase */) {
          const DepositAmount = answers["DepositAmount" /* DepositAmount */];
          if (RepaymentType === getEnumKey(RepaymentTypeENUM, "Repayment" /* Repayment */)) {
            RepaymentValue = PropertyValue - DepositAmount;
            InterestOnlyValue = 0;
          } else if (RepaymentType === getEnumKey(RepaymentTypeENUM, "Interest Only" /* InterestOnly */)) {
            InterestOnlyValue = PropertyValue - DepositAmount;
            RepaymentValue = 0;
          } else if (RepaymentType === getEnumKey(RepaymentTypeENUM, "Both" /* Both */)) {
            RepaymentValue = PropertyValue - DepositAmount - InterestOnlyValue;
          }
        } else if (PurchRemo === "R" /* Remortgage */) {
          const BorrowAmount = answers["BorrowAmount" /* BorrowAmount */];
          if (RepaymentType === getEnumKey(RepaymentTypeENUM, "Repayment" /* Repayment */)) {
        ...
        const MortgageType = ResiBtl === getEnumKey(ResiBtlENUM, "R" /* Residential */) ? 1 /* Residential */ : 2 /* Btl */;
        const TermYears = MortgageLength;
        const SchemePurpose = PurchRemo === "P" /* Purchase */ ? 1 /* Purchase */ : 2 /* Remortgage */;
        const SchemePeriods = JSON.parse(getValueAsLandC("SchemePeriods" /* SchemePeriods */));
        const SchemeTypes = JSON.parse(getValueAsLandC("SchemeTypes" /* SchemeTypes */));
        const filters = MCTManager.getFilters();
        const SortColumn = filters.SortColumn ?? 1 /* Rate */;
        const NumberOfResults = options.NumberOfResults ?? 1;
        const endOfAnswersInput = {
          ShowFTB,
          PropertyValue,
          RepaymentValue,
          InterestOnlyValue,
        ...
        const NewBuild = SchemePurpose === 2 /* Remortgage */ ? null : filters.NewBuild !== null ? filters.NewBuild : FILTERS_CONFIG.NewBuild;
        const SapValue = filters.SapValue === getEnumKey(SapValueENUM, 100 /* Yes */) ? 100 /* Yes */ : filters.SapValue === getEnumKey(SapValueENUM, 69 /* No */) ? 69 /* No */ : getEnumValue(SapValueENUM, FILTERS_CONFIG.SapValue);
        const Features = {};
        if (filters.Offset)
          Features.Offset = filters.Offset;
        if (filters.EarlyRepaymentCharge)
          Features.EarlyRepaymentCharge = filters.EarlyRepaymentCharge;
        if (NewBuild !== null)
          Features.NewBuild = NewBuild === "true" ? true : false;
        ...
        if (PurchRemo === "R" /* Remortgage */) {
          const IncludeRetention = MCTManager.getCalculation(CalculationKeysENUM.IncludeRetention);
          input.IncludeRetention = IncludeRetention;
          const lenderString = answers["Lender" /* Lender */];
          const retentionLenderId = ResiBtl === getEnumKey(ResiBtlENUM, "R" /* Residential */) ? getLenderID(lenderString, "residential") : getLenderID(lenderString, "btl");
          if (retentionLenderId)
            input.RetentionLenderId = Number(retentionLenderId);
        }
        return input;
      };
    }
  ...
  var classes, generateSummaryLines;
  var init_generateSummaryLines = __esm({
    "src/mct/shared/utils/common/generateSummaryLines.ts"() {
      "use strict";
      init_live_reload();
      init_formatting();
      ...
      init_MCTManager();
      classes = DOM_CONFIG.classes;
      generateSummaryLines = (summaryInfo, answers) => {
        ...
        const RepaymentTypeText = RepaymentType === "Repayment" /* Repayment */ ? "repayment" : "Interest Only" /* InterestOnly */ ? "interest only" : "part repayment part interest";
        const SchemePeriodsStringified = JSON.stringify(SchemePeriods);
        const SchemePeriodsText = SchemePeriodsStringified === "[1]" /* TwoYears */ ? "2-year" : SchemePeriodsStringified === "[2]" /* ThreeYears */ ? "3-year" : SchemePeriodsStringified === "[3]" /* FiveYears */ ? "5-year" : SchemePeriodsStringified === "[4]" /* FivePlusYears */ ? "5+ year" : SchemePeriodsStringified === "[1, 2, 3, 4]" /* All */ ? "all" : "2-5+ year";
        const SchemeTypesStringified = JSON.stringify(SchemeTypes);
        const SchemeTypesPrefix = SchemeTypesStringified === "[1]" /* Fixed */ ? "fixed" : SchemeTypesStringified === "[2]" /* Variable */ ? "variable" : "fixed or variable";
  ...
  // src/mct/shared/utils/common/getEnumKey.ts
  var getEnumKey;
  var init_getEnumKey = __esm({
    "src/mct/shared/utils/common/getEnumKey.ts"() {
      "use strict";
      init_live_reload();
  ...
  // src/mct/shared/utils/common/getEnumValue.ts
  var getEnumValue;
  var init_getEnumValue = __esm({
    "src/mct/shared/utils/common/getEnumValue.ts"() {
      "use strict";
      init_live_reload();
      getEnumValue = (enumObj, key) => {
        return enumObj[key];
      };
    }
  });
  ...
  var init_getValueAsLandC = __esm({
    "src/mct/shared/utils/common/getValueAsLandC.ts"() {
      ...
      getValueAsLandC = (key) => {
        ...
        const enumType = enumMap[key];
        if (enumType) {
          if (Array.isArray(value)) {
            return value.map((v) => getEnumValue(enumType, v));
          }
  ...
  // src/mct/shared/config/profiles.ts
  var PROFILES_CONFIG;
  ...
  // src/mct/shared/config/environment.ts
  var getEnvironment2, ENVIRONMENT_CONFIG;
  var init_environment = __esm({
    "src/mct/shared/config/environment.ts"() {
      ...
      ENVIRONMENT_CONFIG = {
        environment: getEnvironment2()
      };
    }
  });

  // src/mct/shared/config/filters.ts
  var FILTERS_CONFIG;
  var init_filters = __esm({
    "src/mct/shared/config/filters.ts"() {
      ...
      FILTERS_CONFIG = {
        NewBuild: "false",
        SapValue: getEnumKey(SapValueENUM, 69 /* No */),
        ShowSharedOwnership: false
      };
    }
  });

  // src/mct/shared/config/events.ts
  var EVENTS_CONFIG;
  ...
  // src/mct/shared/config/index.ts
  var MCT_CONFIG;
  ...
  // src/mct/shared/components/base/BaseComponent.ts
  var BaseComponent;
  var init_BaseComponent = __esm({
    "src/mct/shared/components/base/BaseComponent.ts"() {
      ...
      BaseComponent = class {
         ...
         */
        queryElement(selector, element = this.element) {
          return element.querySelector(selector);
        }
        /**
         * Get child elements by selector
         */
        queryElements(selector, element = this.element) {
          return Array.from(element.querySelectorAll(selector));
        }
        /**
         * Get a child element by attribute selector
         */
        queryElementByAttribute(attribute, value, element = this.element) {
          const query2 = value ? `[${attribute}=${value}]` : `[${attribute}]`;
          return element.querySelector(query2);
        }
        /**
         * Get child elements by attributeselector
         */
        queryElementsByAttribute(attribute, value, element = this.element) {
          const query2 = value ? `[${attribute}=${value}]` : `[${attribute}]`;
          return Array.from(element.querySelectorAll(query2));
        }
        /**
         * Check if element has a specific attribute
         */
        hasAttribute(name, element = this.element) {
          return element.hasAttribute(name);
        }
        /**
         * Get element attribute value
         */
        getAttribute(name, element = this.element) {
         ...
         */
        addStyle(element, style2, value) {
          element.style.setProperty(style2, value);
        }
        /**
         * Remove a style from an element
         */
        removeStyle(element, style2) {
          element.style.removeProperty(style2);
        }
        /**
         * Show an element
         */
         ...
         */
        hasDimensions(element = this.element) {
         ...
         */
        getBoundingClientRect(element = this.element) {
          return element.getBoundingClientRect();
        }
        /**
         * Scroll element into view
         */
        scrollIntoView(options, element = this.element) {
          element.scrollIntoView(options);
        }
        /**
         * Get computed style of element
         */
        getComputedStyle(element = this.element) {
  ...
  // src/mct/shared/components/events/EventBus.ts
  var EventBus;
    ...
    "src/mct/shared/components/events/EventBus.ts"() {
      ...
      EventBus = class _EventBus {
        ...
        on(event, handler) {
          ...
          if (this.debug) {
            debugLog(`\u{1F4E1} EventBus: Subscribed to "${event}"`);
          }
          return () => {
            this.handlers.get(event)?.delete(handler);
            if (this.debug) {
              debugLog(`\u{1F4E1} EventBus: Unsubscribed from "${event}"`);
            }
          };
        }
        /**
        ...
        emit(event, payload) {
          if (this.debug) {
            debugLog(`\u{1F4E1} EventBus: Emitting "${event}"`, payload);
          }
        ...
        clearEvent(event) {
          ...
          if (this.debug) {
            debugLog(`\u{1F4E1} EventBus: Cleared all handlers for "${event}"`);
          }
        }
        /**
         * Clear all handlers
        ...
        clear() {
          ...
          if (this.debug) {
            debugLog(`\u{1F4E1} EventBus: Cleared all handlers`);
          }
        }
      };
    }
  ...
  // src/mct/shared/components/base/InteractiveComponent.ts
  var InteractiveComponent;
  var init_InteractiveComponent = __esm({
    "src/mct/shared/components/base/InteractiveComponent.ts"() {
      "use strict";
      init_live_reload();
      init_BaseComponent();
      init_EventBus();
      InteractiveComponent = class extends BaseComponent {
        constructor(options) {
          super(options);
          this.eventListeners = [];
        ...
        addEventListener(config) {
          ...
          if (!element)
            return this.logError("Cannot add event listener: element is null");
          if (!this.eventListeners)
            return this.logError("Cannot add event listener: eventListeners is null");
          try {
         ...
         */
        removeEventListener(config) {
          const { element, event, handler, options } = config;
          element.removeEventListener(event, handler, options);
          const index2 = this.eventListeners.findIndex((listener) => {
            listener.element === element && listener.event === event && listener.handler === handler;
          });
          if (index2 === -1)
            return;
          this.eventListeners.splice(index2, 1);
        }
        /**
         ...
         */
        createThrottledHandler(handler, delay = 300) {
          let lastCall = 0;
          return (...args) => {
            const now = Date.now();
         ...
         */
        focusFirst(selector, container = this.element) {
          const element = this.queryElement(selector, container);
          element?.focus();
        }
        /**
         ...
         */
        trapFocus(container = this.element) {
  ...
  // src/mct/shared/components/base/StatefulComponent.ts
  var StatefulComponent;
  var init_StatefulComponent = __esm({
    "src/mct/shared/components/base/StatefulComponent.ts"() {
      "use strict";
      init_live_reload();
      init_debug();
      init_InteractiveComponent();
      StatefulComponent = class extends InteractiveComponent {
         ...
         * @returns Unsubscribe function
         */
        subscribeToState(callback2) {
          this.stateSubscribers.add(callback2);
          return () => this.stateSubscribers.delete(callback2);
        }
        /**
         * Notify all state subscribers
         */
        notifyStateSubscribers() {
          if (!this.stateSubscribers)
            return;
          this.stateSubscribers.forEach((callback2) => {
            try {
              callback2(this.state, this.previousState);
            } catch (error) {
  ...
  // src/mct/shared/components/base/StatefulInputGroup.ts
  var StatefulInputGroup;
  var init_StatefulInputGroup = __esm({
    "src/mct/shared/components/base/StatefulInputGroup.ts"() {
      "use strict";
      init_live_reload();
      init_StatefulComponent();
      init_types();
      StatefulInputGroup = class extends StatefulComponent {
        // The inputs in the input group
        constructor(config, customState) {
          const initialState = {
            // Base state
            value: null,
            isValid: false,
        ...
        formatInputNamesAndIDs() {
          ...
          if (this.getStateValue("type") === "radio" || this.getStateValue("type") === "checkbox") {
            this.inputs.forEach((input) => {
              const label = this.queryElement("label", input.parentElement);
            ...
            const label = this.queryElement("label");
        ...
        setSelectValue(value) {
          const input = this.inputs[0];
          if (!input)
            throw new Error("No select input found for select question");
        ...
        setValue(value) {
          ...
          switch (this.getStateValue("type")) {
            ...
            case "select-one":
              if (typeof value !== "string")
                throw new Error("Value for select question must be a string");
        ...
        getLabels() {
          ...
          const labelEls = checked.map((input) => this.queryElement(`label[for="${input.id}"]`));
          return labelEls.map((label) => label.textContent);
        }
        reset() {
          switch (this.getStateValue("type")) {
            case "radio":
  ...
  // src/mct/shared/components/base/StatefulManager.ts
  var init_StatefulManager = __esm({
    "src/mct/shared/components/base/StatefulManager.ts"() {
      "use strict";
      init_live_reload();
      init_StatefulComponent();
  ...
  // src/mct/shared/components/base/index.ts
  var init_base2 = __esm({
    "src/mct/shared/components/base/index.ts"() {
      ...
      init_InteractiveComponent();
      init_StatefulComponent();
      init_StatefulInputGroup();
      init_StatefulManager();
    }
  });

  // src/mct/shared/components/events/index.ts
  ...
  // src/mct/shared/components/index.ts
  ...
  var init_APIClient = __esm({
    "src/mct/shared/api/client/APIClient.ts"() {
      ...
      APIError = class extends Error {
        constructor(message, status, endpoint, response, errorDetails) {
          super(message);
          this.status = status;
      ...
      APIClient = class {
        ...
        async request(endpoint, options = {}) {
          ...
          debugLog("\u{1F504} Request URL: ", url);
          const headers = { ...this.defaultHeaders, ...options.headers };
          const requestOptions = {
            ...options,
            headers
          };
          debugLog("\u{1F504} Request Options: ", requestOptions);
          let lastError = null;
          this.eventBus.emit("mct:api:request:start" /* REQUEST_START */, {
            endpoint: url,
          ...
          for (let attempt = 0; attempt <= this.retries; attempt++) {
            try {
              ...
              this.eventBus.emit("mct:api:request:success" /* REQUEST_SUCCESS */, {
                endpoint: url,
                method: requestOptions.method || "GET",
                response
              });
              ...
              lastError = error;
              this.eventBus.emit("mct:api:request:error" /* REQUEST_ERROR */, {
                endpoint: url,
                method: requestOptions.method || "GET",
                error: lastError
              });
        ...
        async makeRequest(url, options) {
          ...
          try {
            ...
            if (!response.ok) {
              ...
              const errorMessage = errorDetails ? `${errorDetails.title}: ${errorDetails.detail}` : `HTTP ${response.status}: ${response.statusText}`;
            ...
            debugError("\u{1F310} Network error:", {
              url,
  ...
  // src/mct/shared/api/client/ErrorHandler.ts
  ...
  // src/mct/shared/api/client/index.ts
  ...
  // src/mct/shared/api/methods/CreateLeadAndBookingAPI.ts
  var CreateLeadAndBookingAPI;
  var init_CreateLeadAndBookingAPI = __esm({
    "src/mct/shared/api/methods/CreateLeadAndBookingAPI.ts"() {
      "use strict";
      init_live_reload();
      init_APIClient();
      init_config2();
      init_debug();
      CreateLeadAndBookingAPI = class {
        constructor(client) {
          this.client = client;
        }
        async createLeadAndBooking(request) {
          ...
          return this.client.request(API_CONFIG.endpoints.createLeadAndBooking, {
            method: "POST",
    ...
    "src/mct/shared/api/methods/LCIDAPI.ts"() {
      ...
      LCIDAPI = class {
        ...
        async generate(lcid, icid) {
          const response = await this.client.request(API_CONFIG.endpoints.lcid, {
            method: "POST",
            body: JSON.stringify({
              endpoint: "NewEnquiry",
              input: { lcid, icid }
  ...
  var init_LendersAPI = __esm({
    "src/mct/shared/api/methods/LendersAPI.ts"() {
      ...
      LendersAPI = class {
        ...
        async getAll() {
          const response = await this.client.request(API_CONFIG.endpoints.lenders);
          const result = response.result.lenders;
          this.lenders = result;
          return result;
        }
        async getFilteredAndSorted() {
          if (this.lenders.length === 0)
            await this.getAll();
          const response = this.lenders.filter((lender) => lender.LenderName !== "" && lender.LenderName !== null).sort((a, b) => a.LenderName.localeCompare(b.LenderName));
          return response;
        }
      };
    }
  ...
  // src/mct/shared/api/methods/LogUserEventsAPI.ts
  var LogUserEventsAPI;
  var init_LogUserEventsAPI = __esm({
    "src/mct/shared/api/methods/LogUserEventsAPI.ts"() {
      "use strict";
      init_live_reload();
      init_APIClient();
      init_config2();
      init_debug();
      LogUserEventsAPI = class {
        constructor(client) {
          this.client = client;
        }
        async logEvent(request) {
          debugLog("LogUserEventsAPI: ", request);
          return this.client.request(API_CONFIG.endpoints.logUserEvents, {
            method: "POST",
  ...
  // src/mct/shared/api/methods/MortgageAppointmentSlotsAPI.ts
  var MortgageAppointmentSlotsAPI;
  var init_MortgageAppointmentSlotsAPI = __esm({
    "src/mct/shared/api/methods/MortgageAppointmentSlotsAPI.ts"() {
      "use strict";
      init_live_reload();
      init_APIClient();
      init_config2();
      MortgageAppointmentSlotsAPI = class {
        constructor(client) {
          this.client = client;
        }
        async getSlots(dateFrom, dateTo) {
    ...
    "src/mct/shared/api/methods/ProductsAPI.ts"() {
      ...
      ProductsAPI = class {
        ...
        async search(request) {
          debugLog("\u{1F504} [ProductsAPI] Request: ", request);
          return this.client.request(API_CONFIG.endpoints.products, {
            method: "POST",
            body: JSON.stringify({ input: request })
          });
        }
  ...
  // src/mct/shared/api/methods/index.ts
  var init_methods = __esm({
    "src/mct/shared/api/methods/index.ts"() {
      "use strict";
      init_live_reload();
      init_CreateLeadAndBookingAPI();
      init_LCIDAPI();
      init_LendersAPI();
      init_LogUserEventsAPI();
      init_MortgageAppointmentSlotsAPI();
      init_ProductsAPI();
    }
  });

  // src/mct/shared/api/index.ts
  var apiClient, createLeadAndBookingAPI, lcidAPI, lendersAPI, logUserEventsAPI, mortgageAppointmentSlotsAPI, productsAPI;
  var init_api3 = __esm({
    "src/mct/shared/api/index.ts"() {
      "use strict";
      init_live_reload();
      ...
      createLeadAndBookingAPI = new CreateLeadAndBookingAPI(apiClient);
      lcidAPI = new LCIDAPI(apiClient);
      lendersAPI = new LendersAPI(apiClient);
      logUserEventsAPI = new LogUserEventsAPI(apiClient);
      mortgageAppointmentSlotsAPI = new MortgageAppointmentSlotsAPI(apiClient);
      productsAPI = new ProductsAPI(apiClient);
    }
  });

  // src/mct/stages/form/Questions.ts
  var attr7, classes2, QuestionComponent;
  var init_Questions = __esm({
    "src/mct/stages/form/Questions.ts"() {
      ...
      init_common2();
      init_debug();
      attr7 = DOM_CONFIG.attributes.form;
      classes2 = DOM_CONFIG.classes;
      QuestionComponent = class extends StatefulInputGroup {
        constructor(config) {
          const customState = {
            isVisible: false,
            isRequired: true,
        ...
        onInit() {
          ...
          const dependsOn = this.getAttribute(attr7.dependsOn);
          const dependsOnValue = this.getAttribute(attr7.dependsOnValue) || null;
          this.setStateValue("dependsOn", dependsOn);
          this.setStateValue("dependsOnValue", dependsOnValue);
          this.on("mct:form:questions:sync:requested" /* QUESTIONS_SYNC_REQUESTED */, (event) => {
            if (event.targetQuestionId === this.name && event.source !== this.source) {
              this.syncValue(event.value);
            }
          });
          if (this.getStateValue("initialName") === "Lender")
            this.handleLenderSelect();
        }
        getProfile() {
          const groupName = this.getStateValue("groupName");
          const profile = PROFILES_CONFIG.profiles.find((profile2) => profile2.name === groupName);
          return profile;
        }
        getResiBtl() {
        ...
        async handleLenderSelect() {
          ...
          try {
            ...
            const lenders = response.filter((lender) => {
              if (resiBtl === "R" /* Residential */) {
                return lender.ResidentialLenderId !== null;
              } else if (resiBtl === "B" /* Btl */) {
        ...
        require() {
          ...
          this.emit("mct:form:question:required" /* QUESTION_REQUIRED */, {
            question: this,
        ...
        unrequire() {
          ...
          this.emit("mct:form:question:unrequired" /* QUESTION_UNREQUIRED */, {
            question: this,
            questionId: this.name,
            groupName: this.getStateValue("groupName")
          });
        ...
        toggleActive(active) {
          active ? this.toggleClass(this.element, classes2.active, active) : this.toggleClass(this.element, classes2.active);
        }
        activate() {
          this.require();
          this.enable();
        ...
        shouldBeVisible(answers, groupIsVisible) {
          ...
          if (!dependsOn)
            return true;
          if (!dependsOnValue)
            return answers[dependsOn] !== null;
          return answers[dependsOn] === dependsOnValue;
        }
        ...
        handleChange() {
          ...
          if (currentValue !== null) {
            this.emit("mct:form:question:changed" /* QUESTION_CHANGED */, {
              question: this,
              name: this.name,
              groupName: this.getStateValue("groupName"),
              value: currentValue,
  ...
  function dataLayer(event, params = {}) {
    debugLog("PUSHING_TO_DATA_LAYER", { event, ...params });
  ...
  // src/mct/stages/form/QuestionRegistry.ts
  var QuestionRegistry;
  var init_QuestionRegistry = __esm({
    "src/mct/stages/form/QuestionRegistry.ts"() {
      "use strict";
      init_live_reload();
      init_config2();
      ...
      init_types();
      init_common2();
      QuestionRegistry = class _QuestionRegistry {
        constructor() {
         ...
         */
        static getInstance() {
          if (!_QuestionRegistry.instance)
            _QuestionRegistry.instance = new _QuestionRegistry();
          return _QuestionRegistry.instance;
        }
        /**
        ...
        register(question) {
          ...
          if (!this.questions.has(name))
            this.questions.set(name, /* @__PURE__ */ new Set());
         ...
         */
        getByContext(questionName, context) {
         ...
         */
        getAllByNameAndPurchRemo(question) {
          ...
          return Array.from(questions).filter(
            (question2) => question2.getProfile()?.requirements.PurchRemo === currentProfile.requirements.PurchRemo
          );
        }
        /**
        ...
        getValues(options = {}) {
          ...
          this.questions.forEach((questionSet, questionName) => {
            if (excludeSet && excludeSet.has(questionName))
              return;
            if (includeSet && !includeSet.has(questionName))
              return;
            let selectedQuestion = null;
            for (const question of questionSet) {
              if (context && question.getSource() !== context)
                continue;
              if (groupName && question.getGroupName() !== groupName)
                continue;
              if (visibleOnly && !question.getStateValue("isVisible"))
                continue;
              if (validOnly && !question.isValid())
                continue;
         ...
         * ```
         */
        getValuesByPreset(preset, additionalOptions = {}) {
          const presetOptions = {
            formSubmit: {
              context: "main",
              visibleOnly: true,
  ...
  // src/mct/stages/form/QuestionFactory.ts
  var QuestionFactory;
  var init_QuestionFactory = __esm({
    "src/mct/stages/form/QuestionFactory.ts"() {
      "use strict";
      init_live_reload();
      init_Questions();
      init_QuestionRegistry();
      init_types();
      QuestionFactory = class _QuestionFactory {
        /**
        ...
        static create(element, options) {
          ...
          question.initialise();
          const registry2 = QuestionRegistry.getInstance();
          registry2.register(question);
          _QuestionFactory.setupAutoSync(question);
          return question;
        }
        /**
        ...
        static destroy(question) {
          const unsubscribe = question._autoSyncUnsubscribe;
        ...
        static destroyMultiple(questions) {
          questions.forEach((question) => {
            _QuestionFactory.destroy(question);
          });
        }
        /**
        ...
        static setupAutoSync(question) {
          const checkAndSetup = () => {
            ...
            const unsubscribe = question.on("mct:form:question:changed" /* QUESTION_CHANGED */, (event) => {
              if (event.name !== questionName || event.groupName !== groupName || event.source !== source)
                return;
              const registry2 = QuestionRegistry.getInstance();
              const questionsToSync = event.groupName === "customer-identifier" /* CustomerIdentifier */ ? registry2.getAllByName(event.name) : registry2.getAllByNameAndPurchRemo(question);
            ...
            question._autoSyncUnsubscribe = unsubscribe;
          };
          checkAndSetup();
        }
      };
  ...
  var attr8, classes3, BaseGroup, QuestionGroup, MainGroup, OutputGroup;
  var init_Groups = __esm({
    "src/mct/stages/form/Groups.ts"() {
      ...
      init_MCTManager();
      init_components2();
      init_QuestionFactory();
      init_debug();
      attr8 = DOM_CONFIG.attributes.form;
      classes3 = DOM_CONFIG.classes;
      BaseGroup = class extends StatefulComponent {
      ...
      QuestionGroup = class extends BaseGroup {
        constructor(options) {
          const name = options.element.getAttribute(attr8.group);
          const initialState = {
            isVisible: false,
            isActive: false,
            isComplete: false,
            ...
            validQuestions: /* @__PURE__ */ new Set(),
            totalQuestions: 0,
        ...
        updateGroupState() {
          const validQuestions = /* @__PURE__ */ new Set();
         ...
         */
        updateActiveQuestions(preVisible = false) {
          ...
          this.questions.forEach((question, index2) => {
            ...
            if (index2 === 0 && shouldBeVisible && context === "main") {
              question.activate();
          ...
          const lenderQuestion = this.questions.find((q) => q.getStateValue("initialName") === "Lender" /* Lender */);
          if (!lenderQuestion)
            return;
          const lenderQuestionIndex = this.questions.indexOf(lenderQuestion);
          const allBeforeLenderAreValid = this.questions.slice(0, lenderQuestionIndex).filter((q) => q.shouldBeVisible(currentAnswers, this.isVisible)).every((q) => q.isValid());
      ...
      MainGroup = class extends QuestionGroup {
        constructor(options) {
          super(options);
          this.formManager = options.formManager;
        ...
        initQuestions(source = "main") {
          const questionEls = queryElements(`[${attr8.question}]`, this.element);
          return questionEls.map((element, index2) => {
            ...
            if (index2 !== 0)
              question.disable();
            if (question.getStateValue("dependsOn"))
              question.unrequire();
            return question;
          });
        }
        ...
        handleChange(index2) {
          ...
          this.activeQuestionIndex = index2;
          this.formManager.activeGroupIndex = this.state.index;
          this.formManager.updateNavigation({
            prevEnabled: this.state.index !== 0 && index2 !== 0,
            nextEnabled: this.state.name !== "output" /* Output */ && index2 !== this.questions.length - 1
          });
          ...
          const nextIndex = this.getNextRequiredIndex(index2);
          ...
          } else if (this.state.name !== "customer-identifier" /* CustomerIdentifier */ && this.state.name !== "output" /* Output */) {
            const outputGroup = this.formManager.getGroupByName("output" /* Output */);
            if (outputGroup)
              outputGroup.activate(false);
          }
          this.formManager.prepareWrapper();
          this.formManager.handleOutputGroupUpdate(isValid);
        }
        handleEnter(index2) {
          this.navigate("next", index2);
        }
        ...
        getQuestionByIndex(index2) {
          return this.questions[index2];
        }
        getVisibleQuestions() {
        ...
        getNextRequiredIndex(start) {
          let index2 = start + 1;
          while (index2 < this.questions.length && !this.questions[index2].getStateValue("isRequired")) {
            index2 += 1;
          }
          return index2;
        }
        getPrevVisibleIndex(start) {
          let index2 = start - 1;
          while (index2 >= 0 && !this.questions[index2].getStateValue("isVisible")) {
            index2 -= 1;
          }
          return index2;
        }
      ...
      OutputGroup = class extends BaseGroup {
        constructor(options) {
          const name = options.element.getAttribute(attr8.group);
          const initialState = {
            isVisible: false,
        ...
        handleNextStageButton() {
          const availableStages = MCTManager.getAvailableStages();
          if (availableStages.includes("results" /* Results */))
            return;
          const isProceedable = MCTManager.getCalculation("isProceedable" /* IsProceedable */);
        ...
        update() {
          if (!this.state.activated || !this.state.isVisible)
            return;
        ...
        show() {
          this.element.style.removeProperty("display");
          this.setState({ isVisible: true });
          this.emit("mct:form:group:shown" /* GROUP_SHOWN */, { groupId: this.state.name });
        }
        hide() {
          this.element.style.display = "none";
          this.setState({ isVisible: false });
          this.emit("mct:form:group:hidden" /* GROUP_HIDDEN */, { groupId: this.state.name });
        }
        scrollTo() {
        ...
        activate(scrollTo = true) {
          ...
          this.card.classList.add(classes3.active);
          if (scrollTo)
            this.scrollTo();
          this.update();
        }
        ...
        updateOutputs() {
          ...
          this.outputs.forEach((output) => {
            const key = output.getAttribute(attr8.output);
            if (key === "NoProducts") {
  ...
  // src/mct/shared/utils/dom/visibility/removeInitialStyles.ts
  var removeInitialStyles;
  var init_removeInitialStyles = __esm({
    "src/mct/shared/utils/dom/visibility/removeInitialStyles.ts"() {
      "use strict";
      init_live_reload();
      init_config2();
      init_dom();
      removeInitialStyles = (component, delayMS = 0) => {
        const elements2 = queryElements(`[${DOM_CONFIG.attributes.initial}]`, component);
        setTimeout(() => {
  ...
  // src/mct/stages/form/Manager_Base.ts
  var PROFILES, FormManager;
    ...
    "src/mct/stages/form/Manager_Base.ts"() {
      ...
      FormManager = class {
        constructor(component) {
          this.profile = null;
          this.groups = [];
          this.questions = /* @__PURE__ */ new Set();
        ...
        set activeGroupIndex(value) {
          if (this._activeGroupIndex !== value) {
            ...
            this.eventBus.emit("mct:form:group:changed" /* GROUP_CHANGED */, {
              previousIndex,
              currentIndex: value,
        ...
        onMount() {
          removeInitialStyles(this.component, 1e3);
        }
        bindEvents() {
          this.eventBus.on("mct:form:question:required" /* QUESTION_REQUIRED */, ({ question }) => {
            this.saveQuestion(question);
          });
          this.eventBus.on("mct:form:question:unrequired" /* QUESTION_UNREQUIRED */, ({ question }) => {
            this.removeQuestion(question);
          });
        }
        syncQuestionsToState() {
          const answers = MCTManager.getAnswers();
          this.questions.forEach((question) => {
            const answer = answers[question.getStateValue("initialName")];
            if (answer)
        ...
        saveAnswersToMCT(override = false) {
          ...
          [...this.questions].forEach((question) => {
            ...
            answerDataArray.push({
              key: question.getStateValue("initialName"),
              name: question.getStateValue("finalName"),
        ...
        getAnswers(context = "main") {
          return { ...MCTManager.getAnswers(context) };
        }
        determineProfile(context = "main") {
          ...
          MCTManager.setCalculation("BuyerType" /* BuyerType */, profile?.display || void 0);
  ...
  // src/utils/environment/getCurrentBreakpoint.ts
  var getCurrentBreakpoint;
  var init_getCurrentBreakpoint = __esm({
    "src/utils/environment/getCurrentBreakpoint.ts"() {
      "use strict";
      init_live_reload();
  ...
  // src/mct/shared/utils/ui/panelToWindow.ts
  var panelToWindow;
  var init_panelToWindow = __esm({
    "src/mct/shared/utils/ui/panelToWindow.ts"() {
      "use strict";
      init_live_reload();
      init_MCTManager();
      init_dom();
      init_getCurrentBreakpoint();
      panelToWindow = (stageId, to2 = "panel") => {
        const component = MCTManager.getStageDOM(stageId);
        if (!component)
          return;
        const toWindow = to2 === "window" && getCurrentBreakpoint() === "desktop";
        ...
        toWindow ? component.style.backgroundColor = "var(--_mct-themes---surface--background)" : component.style.removeProperty("background-color");
        if (panelBackground)
          toWindow ? panelBackground.style.display = "none" : panelBackground.style.removeProperty("display");
        if (header)
          toWindow ? header.style.paddingTop = "0px" : header.style.removeProperty("padding-top");
        if (stickyHeader)
          toWindow ? stickyHeader.style.top = "0px" : stickyHeader.style.removeProperty("top");
        if (panelButtons)
          toWindow ? panelButtons.style.bottom = "0px" : panelButtons.style.removeProperty("bottom");
      };
    }
  });

  // src/mct/shared/utils/ui/index.ts
  var init_ui = __esm({
    "src/mct/shared/utils/ui/index.ts"() {
      "use strict";
      init_live_reload();
  ...
  var attr9, MainFormManager;
  var init_Manager_Main = __esm({
    "src/mct/stages/form/Manager_Main.ts"() {
      "use strict";
      init_live_reload();
      init_config2();
      ...
      init_ui();
      init_MCTManager();
      attr9 = DOM_CONFIG.attributes.form;
      MainFormManager = class extends FormManager {
        constructor(component) {
          super(component);
          this.identifier = null;
          this.activeHeader = "static";
          this.header = queryElement(`[${attr9.components}="header"]`, component);
          this.secondHeader = queryElement(`[${attr9.components}="sticky-header"]`, component);
          this.identifier = queryElement(`[${attr9.components}="identifier"]`, this.secondHeader);
          this.container = queryElement(`[${attr9.components}="container"]`, component);
        ...
        init() {
          ...
          const groupElements = queryElements(`[${attr9.group}]`, this.list);
          groupElements.forEach((groupEl, index2) => {
            const name = groupEl.getAttribute(attr9.group);
            if (!name)
              return;
            const options = {
              element: groupEl,
          ...
          this.goToNextStageButton.addEventListener("click", () => {
            this.eventBus.emit("mct:stage:complete" /* STAGE_COMPLETE */, { stageId: "questions" /* Questions */ });
          });
          this.eventBus.on("mct:form:group:shown" /* GROUP_SHOWN */, (event) => {
          ...
          this.eventBus.on("mct:form:group:hidden" /* GROUP_HIDDEN */, (event) => {
            if (event.groupId === "output" /* Output */) {
              this.toggleButton(this.nextButton, true);
              this.toggleButton(this.goToNextStageButton, false);
            }
        ...
        determinePanelOrWindow() {
          const isWindow = this.container.offsetHeight <= this.list.offsetHeight;
          isWindow ? panelToWindow("questions" /* Questions */, "window") : panelToWindow("questions" /* Questions */, "panel");
        }
        prepareWrapper() {
        ...
        scrollTo(location2) {
          ...
          } else if (location2 instanceof QuestionComponent) {
            const questionEl = location2.getElement();
            const rect2 = questionEl.getBoundingClientRect();
            const scrollY = window.scrollY;
            const elementTop = rect2.top + scrollY;
            const elementHeight = rect2.height;
        ...
        updateNavigation(options = {}) {
          if (typeof options.nextEnabled === "boolean")
            this.nextButton.disabled = !options.nextEnabled;
          if (typeof options.prevEnabled === "boolean")
            this.prevButton.disabled = !options.prevEnabled;
        }
        handleInputChange(isValid) {
          this.updateNavigation({ nextEnabled: isValid });
        }
        handleOutputGroupUpdate(isValid) {
          if (!isValid)
            return;
          const outputGroup = this.getGroupByName("output" /* Output */);
          if (outputGroup)
        ...
        navigateToPreviousGroup() {
          ...
          if (name === "output" /* Output */ && activeGroup instanceof OutputGroup) {
            ...
            return this.handleShowHideOnGroup();
          if (!previousGroup)
        ...
        showHeader(type) {
          if (!this.header || !this.secondHeader)
            return;
          if (type === "static") {
  ...
  var init_Result = __esm({
    "src/mct/stages/results/Result.ts"() {
      ...
      init_types();
      init_dialogs();
      attr10 = DOM_CONFIG.attributes.results;
      Result = class {
        constructor(wrapper, options) {
          ...
          this.outputs = queryElements(`[${attr10.output}]`, this.template);
          this.button = queryElement(`[${attr10.element}="template-cta"]`, this.template);
          this.init();
        }
        init() {
          this.populate();
        ...
        populate() {
          this.outputs.forEach((output) => {
            const outputName = output.getAttribute(attr10.output);
            const outputType = output.getAttribute(attr10.type);
            let outputValue = this.product[outputName] ?? void 0;
            let outputShow = true;
            switch (outputType) {
              ...
              case "number" /* Number */:
                ...
                outputValue = formatNumber(outputValue, {
                  type: "number",
                  decimals: decimals ? Number(decimals) : void 0
                });
                break;
              case "boolean":
            ...
            if (outputName === "SAP") {
              outputShow = Number(outputValue) > 69 /* No */ ? true : false;
            ...
            if (output instanceof HTMLImageElement) {
              ...
              const rte = queryElement(".w-richtext", output);
              if (rte) {
                rte.innerHTML = "";
  ...
  var init_FilterGroup = __esm({
    "src/mct/stages/results/FilterGroup.ts"() {
      ...
      init_live_reload();
      init_components2();
      FilterComponent = class extends StatefulInputGroup {
        constructor(config) {
          super(config);
        }
        onInit() {
  ...
  // src/mct/shared/utils/dom/visibility/visibility.ts
  ...
  // src/mct/stages/results/Sidebar.ts
  var sidebarAttr, questionAttr, Sidebar, SidebarGroup;
  var init_Sidebar = __esm({
    "src/mct/stages/results/Sidebar.ts"() {
      ...
      init_Groups();
      init_Manager_Base();
      sidebarAttr = DOM_CONFIG.attributes.sidebar;
      questionAttr = DOM_CONFIG.attributes.form;
      Sidebar = class extends FormManager {
        constructor(component) {
          super(component);
          this.groups = [];
          this.source = "sidebar";
          this.list = queryElement(`[${questionAttr.components}="list"]`, component);
          this.updateButton = queryElement(`[${sidebarAttr.components}="update"]`, component);
          this.closeButtons = queryElements(`[${sidebarAttr.components}="close"]`, component);
        ...
        init() {
          ...
          this.bindEvents();
          const groupElements = queryElements(`[${questionAttr.group}]`, this.list);
          groupElements.forEach((groupEl, index2) => {
            const name = groupEl.getAttribute(questionAttr.group);
            if (!name)
              return;
            const options = {
              element: groupEl,
        ...
        syncQuestionsToFilters() {
          const filters = MCTManager.getFilters();
          this.questions.forEach((question) => {
            const answer = filters[question.getStateValue("initialName")];
            if (answer)
              question.setValue(answer);
          });
        }
        ...
        update() {
          ...
          this.eventBus.emit("mct:form:answers:saved" /* ANSWERS_SAVED */, {
      ...
      SidebarGroup = class extends MainGroup {
        ...
        handleChange(index2) {
          if (!(this.formManager instanceof Sidebar))
            return;
          this.activeQuestionIndex = index2;
          this.formManager.activeGroupIndex = this.state.index;
          const question = this.questions[index2];
  ...
  var attr11, sidebarAttr2, ResultsManager;
  var init_Manager = __esm({
    "src/mct/stages/results/Manager.ts"() {
      ...
      init_Sidebar();
      init_debug();
      attr11 = DOM_CONFIG.attributes.results;
      sidebarAttr2 = DOM_CONFIG.attributes.sidebar;
      ResultsManager = class {
        constructor(component) {
          ...
          this.outputs = [];
          this.filters = [];
          this.goToAppointmentButtons = [];
          this.goToOEFButtons = [];
          this.goToLenderButtons = [];
          // private getADecisionButtons: HTMLButtonElement[];
          this.applyDirect = null;
          // private applyDirectButton: HTMLButtonElement | null = null;
          this.applyDirectDialog = null;
          this.allowApplyDirect = false;
          this.results = [];
          this.numberOfResults = 0;
          this.component = component;
          this.id = "results" /* Results */;
          this.eventBus = EventBus.getInstance();
          const sidebar = queryElement(`[${sidebarAttr2.components}="component"]`, this.component);
          this.sidebar = new Sidebar(sidebar);
          this.sidebar.init();
          this.header = queryElement(`[${attr11.components}="header"]`, this.component);
          this.outputs = queryElements(`[${attr11.output}]`, this.header);
          this.updateAnswersButton = queryElement(`[${attr11.components}="update-answers"]`, this.header);
          this.showIfProceedable = queryElements(`[${attr11.showIfProceedable}]`, this.component);
          this.goToAppointmentButtons = queryElements(
            `[${attr11.components}="go-to-appointment"]`,
            this.header
          );
          this.goToOEFButtons = queryElements(`[${attr11.components}="go-to-oef"]`, this.header);
          this.goToLenderButtons = queryElements(`[${attr11.components}="go-to-lender"]`, this.header);
          this.howToApplyDialog = queryElement(
            `[${attr11.components}="how-to-apply-dialog"]`,
            this.component
          );
          this.howToApplyDialogClose = queryElement(
            `[${attr11.components}="how-to-apply-dialog-close"]`,
            this.howToApplyDialog
          );
          this.getFreeAdvice = queryElement(`[${attr11.components}="get-free-advice"]`, this.howToApplyDialog);
          this.getADecision = queryElement(`[${attr11.components}="get-a-decision"]`, this.howToApplyDialog);
          this.applyDirect = queryElement(`[${attr11.components}="apply-direct"]`, this.howToApplyDialog);
          if (this.applyDirect) {
            this.applyDirectDialog = queryElement(
              `[${attr11.components}="apply-direct-redirect"]`,
              this.component
            );
          }
          this.allowApplyDirect = true;
          this.resultsList = queryElement(`[${attr11.components}="list"]`, this.component);
          this.resultsTemplate = queryElement(`[${attr11.components}="template"]`, this.component);
          this.resultsButton = queryElement(`[${attr11.element}="template-cta"]`, this.resultsTemplate);
          this.resultsButtonText = this.resultsButton.textContent;
          this.resultsTemplate.remove();
          this.loader = queryElement(`[${attr11.components}="loader"]`, this.component);
          this.empty = queryElement(`[${attr11.components}="empty"]`, this.component);
          this.pagination = queryElement(`[${attr11.components}="pagination"]`, this.component);
          this.paginationButton = queryElement("button", this.pagination);
          this.eventBus.on("mct:api:request:success" /* REQUEST_SUCCESS */, (event) => {
        ...
        init(options) {
          ...
          this.eventBus.on("mct:form:answers:saved" /* ANSWERS_SAVED */, (event) => {
        ...
        syncFiltersStateToQuestions() {
          const answers = MCTManager.getAnswers();
          this.filters.forEach((filter) => {
            const answer = answers[filter.getStateValue("initialName")];
            if (!answer)
              return;
            filter.setValue(answer);
            MCTManager.setFilter({
              key: filter.getStateValue("initialName"),
        ...
        handleUpdateAnswers() {
          const availableStages = MCTManager.getAvailableStages();
          if (!availableStages.includes("questions" /* Questions */)) {
        ...
        initFilters() {
          const filters = queryElements(`[${attr11.components}="filter-group"]`, this.component);
          this.filters = filters.map((element, index2) => {
        ...
        saveFilterValues() {
          const filterDataArray = this.filters.map((filter) => {
            ...
            const data = { key, name, value, source: "user", valid: filter.isValid(), location: "filter" };
        ...
        initAppointmentDialog() {
          this.isProceedable ? this.getFreeAdvice.style.removeProperty("display") : this.getFreeAdvice.style.display = "none";
        ...
        renderOutputs() {
          ...
          const calculations = MCTManager.getCalculations();
          if (!summaryLines || !calculations)
            return;
          this.outputs.forEach((output) => {
            const key = output.getAttribute(attr11.output);
            const type = output.getAttribute(attr11.type);
            if (key === "LTV") {
              const ltv = calculations["LTV" /* LTV */];
              if (!ltv)
                return;
              if (type === "percentage")
              ...
              const mortgageAmount = calculations["MortgageAmount" /* MortgageAmount */];
              if (!mortgageAmount)
                return;
              if (type === "currency")
                output.textContent = formatNumber(mortgageAmount, { type: "currency" });
              else
                output.textContent = mortgageAmount.toString();
              return;
            }
            if (type === "sentence") {
        ...
        renderFilters() {
          ...
          this.filters.forEach((filterGroup) => {
            const answer = answers[filterGroup.getStateValue("initialName")];
            const config = filters[filterGroup.getStateValue("initialName")];
            if (answer)
              filterGroup.setValue(answer);
            else if (config)
              filterGroup.setValue(config);
          });
        }
        initiateResults() {
          ...
          const buttonText = this.allowApplyDirect && this.isProceedable ? this.resultsButtonText : this.allowApplyDirect && !this.isProceedable ? "Continue online" : this.isProceedable ? this.goToAppointmentButtons[0].textContent : this.goToOEFButtons[0].textContent;
          this.results = this.products.map((product) => {
            return new Result(this.resultsList, {
              template: this.resultsTemplate,
              product,
              onClick: (product2) => this.handleProductCTA(product2),
              buttonText
            });
          });
        ...
        handleButtons() {
          this.goToAppointmentButtons.forEach(
            (button) => button.addEventListener("click", () => {
              this.howToApplyDialog.close();
              this.eventBus.emit("mct:stage:complete" /* STAGE_COMPLETE */, { stageId: "results" /* Results */ });
            })
          );
        ...
        handleShowIfProceedable() {
          this.showIfProceedable.forEach((element) => {
            const showIfProceedable = element.getAttribute(attr11.showIfProceedable) === "true";
        ...
        getSortColumnValue() {
          ...
          if (!sortColumnInput)
            return 1 /* Rate */;
          const sortColumnValue = sortColumnInput.getStateValue("value");
          if (!sortColumnValue)
            return 1 /* Rate */;
        ...
        async fetchProducts() {
          ...
          try {
            ...
            debugError("\u{1F504} [ResultsManager] fetchProducts", error);
            return null;
          }
        }
        ...
        showListUI(component, show) {
          const componentEl = component === "loader" ? this.loader : component === "empty" ? this.empty : component === "pagination" ? this.pagination : null;
          if (!componentEl)
            return;
          show ? componentEl.style.removeProperty("display") : componentEl.style.display = "none";
          const showResultsList = this.state === "loaded" ? true : this.state === "loading" ? false : component === "loader" || component === "empty" ? !show : true;
        ...
        async handleDirectToLender() {
          ...
          try {
            ...
            const title = queryElement(
              `[${attr11.components}="apply-direct-redirect-title"]`,
            ...
            debugError("\u{1F504} [ResultsManager] handleDirectToLender", error);
            window.open(this.product?.ApplyDirectLink || "", "_blank");
            this.applyDirectDialog?.close();
          }
        }
        handleLogUserEvents(EventName, lender = "") {
          const payload = {
            EventName,
            EventValue: lender
          };
  ...
  function toggleClass(elm, classes4, add) {
    if (elm) {
      forEach(classes4, function(name) {
        if (name) {
  ...
  function addClass(elm, classes4) {
    toggleClass(elm, isString(classes4) ? classes4.split(" ") : classes4, true);
  }
  ...
  function removeAttribute(elms, attrs) {
    forEach(elms, function(elm) {
      forEach(attrs, function(attr16) {
        elm && elm.removeAttribute(attr16);
      });
    });
  }
  ...
  function getAttribute(elm, attr16) {
    return elm.getAttribute(attr16);
  }
  ...
  function removeClass(elm, classes4) {
    toggleClass(elm, classes4, false);
  }
  function timeOf(e) {
    return e.timeStamp;
  }
  ...
  function EventInterface(Splide2) {
    ...
    function on(events, callback2) {
      binder.bind(bus, toArray(events).join(" "), function(e) {
        callback2.apply(callback2, isArray2(e.detail) ? e.detail : []);
      });
    }
    function emit(event) {
  ...
  function closest(from2, selector) {
  ...
  function Slide$1(Splide2, index2, slideIndex, slide) {
    ...
    function isWithin(from2, distance) {
      var diff = abs(from2 - index2);
  ...
  function Move(Splide2, Components2, options) {
    ...
    function move(dest, index2, prev, callback2) {
    ...
    function go(control, allowSameIndex, callback2) {
      if (!isBusy()) {
        ...
        if (index2 > -1 && (allowSameIndex || index2 !== currIndex)) {
          setIndex(index2);
          Move2.move(dest, index2, prevIndex, callback2);
        }
      }
    }
  ...
  function Arrows(Splide2, Components2, options) {
    ...
    var classes4 = options.classes, i18n = options.i18n;
    ...
    function createArrows() {
      wrapper = placeholder || create("div", classes4.arrows);
    ...
    function createArrow(prev2) {
      var arrow = '<button class="' + classes4.arrow + " " + (prev2 ? classes4.prev : classes4.next) + '" type="button"><svg xmlns="' + XML_NAME_SPACE + '" viewBox="0 0 ' + SIZE + " " + SIZE + '" width="' + SIZE + '" height="' + SIZE + '" focusable="false"><path d="' + (options.arrowPath || PATH) + '" />';
  ...
  function Scroll(Splide2, Components2, options) {
    ...
    function scroll(destination, duration, snap, onScrolled, noConstrain) {
      var from2 = getPosition();
      clear();
      if (snap && (!isSlide || !exceededLimit())) {
        var size = Components2.Layout.sliderSize();
        var offset = sign2(destination) * size * floor(abs(destination) / size) || 0;
        destination = Move2.toPosition(Components2.Controller.toDest(destination % size)) + offset;
      }
      var noDistance = approximatelyEqual(from2, destination, 1);
      friction = 1;
      duration = noDistance ? 0 : duration || max(abs(destination - from2) / BASE_VELOCITY, MIN_DURATION);
      callback2 = onScrolled;
      interval = RequestInterval(duration, onEnd, apply(update, from2, destination, noConstrain), 1);
      set2(SCROLLING);
      emit(EVENT_SCROLL);
      interval.start();
    }
    ...
    function update(from2, to2, noConstrain, rate) {
      var position = getPosition();
      var target = from2 + (to2 - from2) * easing(rate);
  ...
  function Drag(Splide2, Components2, options) {
    ...
    function computeDestination(velocity) {
      return getPosition() + sign2(velocity) * min(abs(velocity) * (options.flickPower || 600), isFree ? Infinity : Components2.Layout.listSize() * (options.flickMaxPages || 1));
    }
  ...
  function Pagination(Splide2, Components2, options) {
    ...
    function createPagination() {
      ...
      var classes4 = options.classes, i18n = options.i18n, perPage = options.perPage;
      var max2 = hasFocus() ? Controller2.getEnd() + 1 : ceil(length / perPage);
      list = placeholder || create("ul", classes4.pagination, Elements2.track.parentElement);
  ...
  var init_splide_esm = __esm({
    "node_modules/.pnpm/@splidejs+splide@4.1.4/node_modules/@splidejs/splide/dist/js/splide.esm.js"() {
      ...
      isFunction2 = apply(typeOf, "function");
      ...
      ALL_ATTRIBUTES = [ROLE, TAB_INDEX, DISABLED, ARIA_CONTROLS, ARIA_CURRENT, ARIA_LABEL, ARIA_LABELLEDBY, ARIA_HIDDEN, ARIA_ORIENTATION, ARIA_ROLEDESCRIPTION];
      ...
      SIZE = 40;
      INTERVAL_DATA_ATTRIBUTE = DATA_ATTRIBUTE + "-interval";
      BOUNCE_DIFF_THRESHOLD = 10;
      BOUNCE_DURATION = 600;
      FRICTION_FACTOR = 0.6;
      BASE_VELOCITY = 1.5;
      MIN_DURATION = 800;
  ...
  // src/mct/stages/appointment/Config.ts
  var Config_exports = {};
  __export(Config_exports, {
    ConfigManager: () => ConfigManager
  });
  var SLIDER_CONFIG, ConfigManager;
  var init_Config = __esm({
    "src/mct/stages/appointment/Config.ts"() {
      "use strict";
      init_live_reload();
      ...
      init_getCurrentBreakpoint();
      init_config2();
      SLIDER_CONFIG = COMPONENTS_CONFIG.slider;
  ...
  // src/mct/stages/appointment/Slider.ts
  var Slider;
    ...
    "src/mct/stages/appointment/Slider.ts"() {
      ...
      Slider = class {
        ...
        calculateWidth() {
          if (!this.wrapper)
            return "100%";
          const style2 = window.getComputedStyle(this.wrapper);
  ...
  // src/mct/stages/appointment/Dates.ts
  var attr12, DatesComponent;
  var init_Dates = __esm({
    "src/mct/stages/appointment/Dates.ts"() {
      ...
      init_formatting();
      init_Slider();
      attr12 = DOM_CONFIG.attributes.appointment;
      DatesComponent = class extends StatefulInputGroup {
        constructor(config) {
          const customState = {
            appointmentDays: [],
            selectedDate: null
        ...
        onInit() {
          const slider = this.queryElement(`[${attr12.slider}="component"]`, this.wrapper);
        ...
        addDays(days) {
          ...
          const slides = days.map((day, index2) => this.createDateSlide(day, index2));
        ...
        createSlideTemplate() {
          const slide = queryElement(`[${attr12.slider}="slide-template"]`, this.element);
          if (!slide)
            throw new Error(`Slide template element with attribute [${attr12.slider}="slide-template"] not found`);
          const template = slide.cloneNode(true);
          const slideParent = slide.parentElement;
          if (slideParent)
            [...slideParent.children].forEach((child2) => child2.remove());
          return template;
        }
        createDateSlide(day, index2) {
          const slide = this.slideTemplate.cloneNode(true);
          slide.setAttribute(attr12.date, day.date);
          const monthLabel = queryElement(`[${attr12.inputLabel}="month"]`, slide);
          const dayLabel = queryElement(`[${attr12.inputLabel}="day"]`, slide);
          ...
          const input = queryElement("input", slide);
          input.id = `preferred-date-${day.date}`;
          input.disabled = !enabled;
          input.value = day.date;
          const label = queryElement("label", slide);
  ...
  // src/utils/formatting/formatToHHMM.ts
  var formatToHHMM;
  var init_formatToHHMM = __esm({
    "src/utils/formatting/formatToHHMM.ts"() {
      "use strict";
      init_live_reload();
      formatToHHMM = (t) => {
  ...
  // src/mct/stages/appointment/Times.ts
  var mctAttr, attr13, TimesComponent;
  var init_Times = __esm({
    "src/mct/stages/appointment/Times.ts"() {
      ...
      init_config2();
      init_formatToHHMM();
      mctAttr = DOM_CONFIG.attributes.component;
      attr13 = DOM_CONFIG.attributes.appointment;
      TimesComponent = class extends StatefulInputGroup {
        constructor(config) {
          super(config);
          this.setStateValue("type", "radio");
          this.list = this.queryElement(`[${attr13.components}="times-list"]`);
          const slot = this.queryElement(`[${mctAttr}="pill"]`);
          this.template = slot.cloneNode(true);
          this.template.remove();
        }
        onInit() {
        }
  ...
  // src/mct/stages/appointment/Form.ts
  var InputGroup;
  var init_Form = __esm({
    "src/mct/stages/appointment/Form.ts"() {
      "use strict";
      init_live_reload();
      init_components2();
      InputGroup = class extends StatefulInputGroup {
        constructor(config) {
          super(config);
        }
        onInit() {
  ...
  var init_Manager2 = __esm({
    "src/mct/stages/appointment/Manager.ts"() {
      ...
      AppointmentManager = class {
        constructor(component) {
          this.isInitialised = false;
          this.stateManager = MCTManager.getStateManager();
          this.visibilityManager = MCTManager.getVisibilityManager();
          this.currentPanel = PANEL_ENUM.CALENDAR;
          this.today = new Date((/* @__PURE__ */ new Date()).toLocaleString("en-US", { timeZone: "Europe/London" }));
          this.lastDate = new Date(this.today);
          this.formInputGroups = [];
          // Appointment slots data
          this.appointmentDays = [];
          this.selectedDate = null;
          this.isLoading = false;
          this.hasError = false;
          this.dateAndTimeSet = false;
          this.component = component;
          this.id = "appointment" /* Appointment */;
          this.loader = queryElement(`[${attr14.components}="loader"]`, this.component);
          this.backButtons = queryElements(`[${attr14.components}="back"]`, this.component);
          this.bookButton = queryElement(`[${attr14.components}="book"]`, this.component);
          this.calendarPanel = queryElement(`[${attr14.panel}="${PANEL_ENUM.CALENDAR}"]`, this.component);
          this.datesGroup = queryElement(`[${attr14.components}="dates"]`, this.calendarPanel);
          this.timesGroup = queryElement(`[${attr14.components}="times"]`, this.calendarPanel);
          this.dates = new DatesComponent({
            element: this.datesGroup,
            debug: true,
            onChange: () => this.handleDateChange(),
            wrapper: queryElement(`[${attr14.components}="content"]`, this.calendarPanel),
          ...
          this.formPanel = queryElement(`[${attr14.panel}="${PANEL_ENUM.FORM}"]`, this.component);
          this.tags = queryElements(`[${attr14.components}="tag"]`, this.formPanel);
          this.form = queryElement(`form`, this.formPanel);
          this.formError = queryElement(`[${attr14.form}="error"]`, this.formPanel);
          this.formSuccess = queryElement(`[${attr14.form}="success"]`, this.formPanel);
          this.tryAgainDialog = queryElement(`[${attr14.components}="try-again"]`, this.formPanel);
          this.tryAgainButton = queryElement(
            `[${attr14.components}="back-to-calendar"]`,
            this.tryAgainDialog
          );
        }
        init(options) {
          ...
          this.formInputGroups = inputGroups.map((input, index2) => {
        ...
        saveBooking() {
          ...
          const startTime = formatToHHMM(timeParts[0]).trim();
          const endTime = formatToHHMM(timeParts[1]).trim();
        ...
        async handleDays(isInit, startDate) {
        ...
        calculateFetchStartDate(isInit, startDate) {
          if (isInit) {
            return startDate;
          } else {
        ...
        async calculateDateRange(isInit, fetchStartDate) {
        ...
        shouldFetchMoreDays(endDate) {
          if (endDate <= this.lastDate) {
            return false;
          }
          return true;
        }
        async fetchAppointmentSlots(startDate, endDate) {
        ...
        async handleFormSubmission() {
          ...
          if (!stateData) {
            ...
            if (Vulnerable === "Yes")
              stateData.Notes = `Vulnerable: ${Vulnerable} - Notes: ${VulnerableMessage}`;
          }
        ...
        getStateData() {
          ...
          const answers = MCTManager.getAnswers();
          const calculations = MCTManager.getCalculations();
          const PurchRemo = getEnumValue(PurchRemoENUM, this.getStringAnswer(answers, "PurchRemo" /* PurchRemo */));
          if (!PurchRemo)
            throw new Error("PurchRemo is required");
          if (PurchRemo === "P" /* Purchase */) {
        ...
        createBaseEnquiry(state, answers, calculations, PurchRemo) {
          const ChosenMCTProduct = MCTManager.getProduct()?.toString();
          return {
            lcid: state.lcid,
            icid: state.icid,
            BuyerType: calculations["BuyerType" /* BuyerType */],
            PurchRemo,
            ResiBtl: getEnumValue(ResiBtlENUM, this.getStringAnswer(answers, "ResiBtl" /* ResiBtl */)),
            PropertyValue: this.getNumericAnswer(answers, "PropertyValue" /* PropertyValue */),
            RepaymentType: getEnumValue(
              RepaymentTypeENUM,
              this.getStringAnswer(answers, "RepaymentType" /* RepaymentType */)
            ),
            MortgageLength: this.getNumericAnswer(answers, "MortgageLength" /* MortgageLength */),
            LTV: calculations.LTV,
            CreditImpaired: getEnumValue(
              CreditImpairedENUM,
              this.getStringAnswer(answers, "CreditImpaired" /* CreditImpaired */)
            ),
            LoanAmount: calculations.MortgageAmount,
            InterestOnlyAmount: this.getNumericAnswer(answers, "InterestOnlyValue" /* InterestOnlyValue */),
            ...ChosenMCTProduct && { ChosenMCTProduct }
          };
        }
        createPurchaseEnquiry(state, answers, calculations) {
          return {
            ...this.createBaseEnquiry(state, answers, calculations, "P" /* Purchase */),
            PurchasePrice: this.getNumericAnswer(answers, "PropertyValue" /* PropertyValue */),
            OfferAccepted: calculations.offerAccepted,
            ReadinessToBuy: getEnumValue(
              ReadinessToBuyENUM,
              this.getStringAnswer(answers, "ReadinessToBuy" /* ReadinessToBuy */)
            ),
            DepositAmount: this.getNumericAnswer(answers, "DepositAmount" /* DepositAmount */),
            FTB: getEnumValue(FTBENUM, this.getStringAnswer(answers, "FTB" /* FTB */)) ?? "N" /* No */,
            NewBuild: getEnumValue(NewBuildENUM, this.getStringAnswer(answers, "NewBuild" /* NewBuild */)) ?? "N" /* No */
          };
        }
        createRemortgageEnquiry(state, answers, calculations) {
          const resiBtlValue = this.getStringAnswer(answers, "ResiBtl" /* ResiBtl */);
          const resiBtlKey = resiBtlValue === getEnumKey(ResiBtlENUM, "R" /* Residential */) ? "residential" : "btl";
          const lender = this.getStringAnswer(answers, "Lender" /* Lender */);
          const CurrentLender = getLenderID(lender, resiBtlKey);
          return {
            ...this.createBaseEnquiry(state, answers, calculations, "R" /* Remortgage */),
            DatePlanToRemo: getEnumValue(
              DatePlanToRemoENUM,
              this.getStringAnswer(answers, "DatePlanToRemo" /* DatePlanToRemo */)
            ),
            CurrentLender
          };
        }
  ...
  // src/mct/stages/appointment/index.ts
  var initAppointment;
  var init_appointment = __esm({
    "src/mct/stages/appointment/index.ts"() {
      "use strict";
      init_live_reload();
      init_Manager2();
      initAppointment = (component) => {
        return new AppointmentManager(component);
      };
    }
  });

  // src/mct/shared/state/CalculationManager.ts
  var CalculationManager;
  var init_CalculationManager = __esm({
    "src/mct/shared/state/CalculationManager.ts"() {
      "use strict";
      init_live_reload();
      init_types();
      ...
      CalculationManager = class {
        constructor(stateManager3) {
          ...
          this.calculateLoanToValue = (answers) => {
            ...
            if (!PurchRemo || !PropertyValue)
              return { ["LTV" /* LTV */]: void 0 };
            let LTV = void 0;
            if (PurchRemo === getEnumKey(PurchRemoENUM, "P" /* Purchase */) && DepositAmount) {
              LTV = (PropertyValue - DepositAmount) / PropertyValue * 100;
            } else if (PurchRemo === getEnumKey(PurchRemoENUM, "R" /* Remortgage */) && BorrowAmount) {
          ...
          this.calculateIncludeRetention = (answers) => {
            ...
            if (PurchRemo !== getEnumKey(PurchRemoENUM, "R" /* Remortgage */) || !RemoChange)
              return { [CalculationKeysENUM.IncludeRetention]: void 0 };
            const remoChangeValue = getEnumValue(RemoChangeENUM, RemoChange);
            const IncludeRetention = remoChangeValue === 1 /* NoChange */;
          ...
          this.calculateIsProceedable = (answers) => {
            ...
            if (!CreditImpaired || CreditImpaired === getEnumKey(CreditImpairedENUM, "Y" /* Yes */)) {
              isProceedable = false;
            }
            if (PurchRemo === getEnumKey(PurchRemoENUM, "P" /* Purchase */)) {
              if (!ReadinessToBuy || ReadinessToBuy === getEnumKey(ReadinessToBuyENUM, "R" /* Researching */) || ReadinessToBuy === getEnumKey(ReadinessToBuyENUM, "V" /* Viewing */)) {
                isProceedable = false;
              }
            } else if (PurchRemo === getEnumKey(PurchRemoENUM, "R" /* Remortgage */)) {
              if (!DatePlanToRemo || DatePlanToRemo === getEnumKey(DatePlanToRemoENUM, "Over 12 months" /* TwelvePlusMonths */)) {
                isProceedable = false;
              }
            }
            return {
              ["isProceedable" /* IsProceedable */]: isProceedable
            };
          };
          /**
          ...
          this.calculateMortgageAmount = (answers) => {
            const { PurchRemo, PropertyValue, DepositAmount, BorrowAmount } = answers;
            if (!PurchRemo)
              return { ["MortgageAmount" /* MortgageAmount */]: void 0 };
            let MortgageAmount = void 0;
            if (PurchRemo === getEnumKey(PurchRemoENUM, "P" /* Purchase */) && DepositAmount && PropertyValue) {
              MortgageAmount = PropertyValue - DepositAmount;
            } else if (PurchRemo === getEnumKey(PurchRemoENUM, "R" /* Remortgage */) && BorrowAmount) {
              MortgageAmount = BorrowAmount;
            }
            return { ["MortgageAmount" /* MortgageAmount */]: MortgageAmount };
          };
          /**
           ...
           */
          this.calculateOfferAccepted = (answers) => {
            const { PurchRemo, ReadinessToBuy } = answers;
            if (PurchRemo !== getEnumKey(PurchRemoENUM, "P" /* Purchase */))
              return { ["offerAccepted" /* OfferAccepted */]: void 0 };
            if (!ReadinessToBuy)
              return { ["offerAccepted" /* OfferAccepted */]: "N" /* No */ };
            const readinessToBuyValue = getEnumValue(ReadinessToBuyENUM, ReadinessToBuy);
            const isOfferAccepted = readinessToBuyValue === "A" /* OfferAccepted */;
            const offerAccepted = isOfferAccepted ? "Y" /* Yes */ : "N" /* No */;
            return { ["offerAccepted" /* OfferAccepted */]: offerAccepted };
          };
          this.stateManager = stateManager3;
          this.calculationRules = /* @__PURE__ */ new Map();
          this.setupCalculationRules();
          this.subscribeToStateChanges();
        }
        setupCalculationRules() {
          this.calculationRules.set("PurchRemo" /* PurchRemo */, this.purchRemo);
          this.calculationRules.set("ReadinessToBuy" /* ReadinessToBuy */, this.readinessToBuy);
          this.calculationRules.set("CreditImpaired" /* CreditImpaired */, this.creditImpaired);
          this.calculationRules.set("DatePlanToRemo" /* DatePlanToRemo */, this.datePlanToRemo);
          this.calculationRules.set("PropertyValue" /* PropertyValue */, this.propertyValue);
          this.calculationRules.set("DepositAmount" /* DepositAmount */, this.depositAmount);
          this.calculationRules.set("RemoChange" /* RemoChange */, this.remoChange);
          this.calculationRules.set("BorrowAmount" /* BorrowAmount */, this.borrowAmount);
        }
        subscribeToStateChanges() {
          this.stateManager.subscribe((event) => {
            if (event.changes.inputs)
              this.runCalculations(event.currentState.inputs);
          });
        }
        runCalculations(answers) {
          const newCalculations = {};
          this.calculationRules.forEach((calculationFn, answerKey) => {
            if (answers[answerKey] !== void 0) {
              const result = calculationFn(answers);
              Object.assign(newCalculations, result);
            }
          });
          const definedCalculations = {};
          Object.entries(newCalculations).forEach(([key, value]) => {
            if (value !== void 0) {
              definedCalculations[key] = value;
            }
          });
  ...
  var PERSISTENCE_CONFIG, StatePersistenceManager;
  ...
  var memoryStore, StorageManager;
  ...
  var init_StateManager = __esm({
    "src/mct/shared/state/StateManager.ts"() {
      ...
      StateManager = class {
        ...
        setCurrentStageIndex(index2) {
          this.set("currentStageIndex", index2);
        }
         ...
         */
        overrideAnswers(answerDataArray) {
          const answers = answerDataArray.reduce((acc, answer) => {
            acc[answer.key] = answer.value;
            return acc;
          }, {});
  ...
  // src/mct/shared/state/VisibilityManager.ts
  var VisibilityManager;
  var init_VisibilityManager = __esm({
    "src/mct/shared/state/VisibilityManager.ts"() {
      "use strict";
      init_live_reload();
      init_config2();
      ...
      VisibilityManager = class {
        constructor(stateManager3) {
          ...
          this.visibilityCache = /* @__PURE__ */ new Map();
          this.stateManager = stateManager3;
          this.subscribeToStateChanges();
        }
        /**
         ...
         */
        evaluateElementVisibility(element, condition) {
         ...
         */
        evaluateParsedCondition(condition) {
        ...
        getVariableValue(variable) {
          ...
          if (answers && variable in answers)
            return answers[variable];
          else if (calculations && variable in calculations)
            return calculations[variable];
          else if (formData && variable in formData)
  ...
  // src/mct/shared/state/index.ts
  var init_state2 = __esm({
    "src/mct/shared/state/index.ts"() {
      "use strict";
      init_live_reload();
      init_CalculationManager();
      init_persistence();
      init_StateManager();
      init_StorageManager();
      init_VisibilityManager();
    }
  });

  // src/mct/shared/MCTManager.ts
  var VERSION, attr15, eventBus, isFirstStage, stageManagers, dom, stateManager, calculationManager, visibilityManager, questionRegistry, MCTManager;
  var init_MCTManager = __esm({
    "src/mct/shared/MCTManager.ts"() {
      "use strict";
      init_live_reload();
      init_dom();
      ...
      init_dataLayer();
      init_debug();
      VERSION = "\u{1F504} MCT DIST v2.1.0";
      ...
      visibilityManager = new VisibilityManager(stateManager);
      questionRegistry = QuestionRegistry.getInstance();
      MCTManager = {
        start() {
          const dom2 = this.initDOM();
          if (!dom2)
            return;
          this.initState();
          this.initICID();
        ...
        initState() {
          debugLog("\u{1F504} Initializing MCTManager...");
          debugLog(VERSION);
          stateManager.subscribe((event) => {
            debugLog("\u{1F504} State changed via new manager:", {
        ...
        initDOM() {
          dom.component = queryElement(`[${attr15.component}="component"]`);
          if (!dom.component)
            return null;
          const stages = queryElements(`[${attr15.stage}]`, dom.component);
          stages.forEach((stage) => {
            const name = stage.getAttribute(attr15.stage);
            if (name)
        ...
        initStages() {
          ...
          const appointment = this.getStageDOM("appointment" /* Appointment */);
          if (mainForm) {
        ...
        route() {
          if (stageManagers.length === 0) {
            return debugError("\u{1F504} No stage managers present");
          }
          debugLog("\u{1F504} Available stages:", this.getAvailableStages());
          this.goToNextStage();
          eventBus.on("mct:stage:complete" /* STAGE_COMPLETE */, (event) => {
            debugLog("\u{1F504} Stage complete", event);
            this.goToNextStage();
          });
        },
        getAvailableStages() {
        ...
        getAnswersAsLandC() {
          return Object.fromEntries(
            Object.entries(this.getAnswers()).map(([key, value]) => [key, getValueAsLandC(key)])
        ...
        setFilters(filterDataArray) {
          const filters = filterDataArray.reduce((acc, filter) => {
  ...
  init_live_reload();
  init_getBaseURLForAPI();
  var baseURLForAPI = getBaseURLForAPI();
  var API_ENDPOINTS = {
  ...
  var HandleTable = class {
    ...
    getValues() {
      ...
      const formattedValues = {
        ...
        NumberOfResults: "100",
        Features: {
          EarlyRepaymentCharge: preFormattedValues.Erc,
  ...
  // src/bestbuys/index.ts
  var bestbuys = () => {
    const attr16 = "data-bb";
    const components2 = queryElements(`[${attr16}]`);
  ...
  function addRoundedRectPath(ctx, rect2) {
    const { x, y, w, h, radius } = rect2;
  ...
  function getCanvasPosition(e, canvas) {
    ...
    if (useOffsetPos(offsetX, offsetY, e.target)) {
      ...
      x = source.clientX - rect2.left;
      y = source.clientY - rect2.top;
      box = true;
    }
    return {
      x,
  ...
  function getContainerSize(canvas, width, height) {
    ...
    if (width === void 0 || height === void 0) {
      ...
      if (!container) {
        ...
        width = rect2.width - containerPadding.width - containerBorder.width;
        height = rect2.height - containerPadding.height - containerBorder.height;
  ...
  function addNormalRectPath(ctx, rect2) {
    ctx.rect(rect2.x, rect2.y, rect2.w, rect2.h);
  }
  function inflateRect(rect2, amount, refRect = {}) {
    const x = rect2.x !== refRect.x ? -amount : 0;
    const y = rect2.y !== refRect.y ? -amount : 0;
    const w = (rect2.x + rect2.w !== refRect.x + refRect.w ? amount : 0) - x;
    const h = (rect2.y + rect2.h !== refRect.y + refRect.h ? amount : 0) - y;
    return {
      x: rect2.x + x,
      y: rect2.y + y,
      w: rect2.w + w,
      ...
      try {
        ...
        if (resultsId && calcName === "residentialborrowinglimit") {
          ...
          if (mortgageCalcComponent) {
            if (!this.mortgageCalc)
              this.mortgageCalc = new _HandleCalculator(mortgageCalcComponent);
            const mortInputs = this.mortgageCalc.inputs.getValues();
            ...
            console.log("residentialborrowinglimit", {
              DepositAmount,
              RepaymentValue,
              PropertyValue
            });
            ...
            if (prodresult) {
              ...
              setTimeout(() => {
                this.mortgageCalc?.submit();
              }, 250);
            }
          }
        } else if (resultsId && calcName === "mortgagecost") {
          const DepositAmount = parseFloat(this.inputs.getValues()["DepositAmountSlider"] || "0");
          const RepaymentValue = parseFloat(this.inputs.getValues()["RepaymentValue"] || "0");
          const PropertyValue = RepaymentValue + DepositAmount;
          syncSlider("DepositAmountSlider", DepositAmount);
          syncSlider("RepaymentValue", RepaymentValue);
          console.log("mortgagecost", {
            values: this.inputs.getValues(),
            DepositAmount,
            RepaymentValue,
            PropertyValue
          });
          const prodresult = await this.makeAzureRequestProduct({
            PropertyValue,
            RepaymentValue,
            TermYears: parseFloat(this.inputs.getValues()["TermYears"] || "0"),
            PropertyType: 1,
            MortgageType: 1
          });
          if (prodresult) {
  ...
  var calculators = () => {
    ...
    if (repaymentValueSlider)
      repaymentValueSlider.setAttribute(`${attr16}-output`, "BorrowingAmountHigher");
    if (depositAmountSlider)
      depositAmountSlider.setAttribute(`${attr16}-output`, "DepositAmount");
    if (rateSlider)
      rateSlider.setAttribute(`${attr16}-output`, "InitialRate");
    const components2 = queryElements(`[${attr16}]`);
    components2.forEach((component) => {
  ...
  var details = () => {
    document.addEventListener("click", (event) => {
      ...
      if (!target)
        return;
      const details2 = target.closest("details");
      if (!details2)
        return;
      const icon = queryElement('[data-details="icon"]', details2);
      if (!icon)
        return;
      const { open } = details2;
      let rotate2 = icon.dataset.detailsIconRotate;
      if (!rotate2)
        rotate2 = "180";
      const rotateBy = open ? "0deg" : `${rotate2}deg`;
  ...
  var CostOfDoingNothingCalculator = class {
    constructor(component) {
      ...
      this.formattedCostOfDoingNothingValues = {};
      this.component = component;
      this.inputs = queryElements(`[data-input], input, select`, component);
  ...
  // src/partner-booker/utils/dates.ts
  init_live_reload();
  ...
  function makeDateBtn(day, tpl) {
    const d = new Date(day.date);
    const btn = tpl.cloneNode(true);
    const input = btn.querySelector(".mct_pill_input");
    const lab = btn.querySelector("label.hide");
    const mEl = btn.querySelector('[data-mct-appointment-input-label="month"]');
    const dayEl = btn.querySelector('[data-mct-appointment-input-label="day"]');
  ...
  var partnerBookingWidget = class {
    constructor(element) {
      ...
      this.injectParameterIntoImageURL = () => {
        var lenderParam = this.getUrlParameter("lender");
        console.log(lenderParam);
        var image = document.querySelector(".lender-logo-dynamic");
        var div = document.querySelector(".block_lender-information");
        if (lenderParam !== "") {
      ...
      this.tryAgainDialog = queryElement(`[data-partner-element="try-again"]`, this.wrap);
    ...
    initState() {
      ...
      stateManager2.loadFromPersistence();
    ...
    async getDateSlots() {
      ...
      const to2 = new Date(from2);
      to2.setDate(to2.getDate() + 14);
      const fromDate = formatDateForAPI(from2);
      const toDate = formatDateForAPI(to2);
      const response = await mortgageAppointmentSlotsAPI.getSlots(fromDate, toDate);
      return response;
    }
    setTimeSlots(day) {
      const list = queryElement(`[data-partner-element="${DOM_CONFIG2.elements.timeList}"]`, this.wrap);
      if (!list)
        return;
      const tpl = list.querySelector(".mct_pill_field");
      const base = tpl.cloneNode(true);
      list.innerHTML = "";
      for (const s of day.slots ?? []) {
        const el = base.cloneNode(true);
        const input = el.querySelector(".mct_pill_input");
        const label = el.querySelector(".mct_pill_label");
    ...
    readEnquiryFormFromDOM() {
      const root = queryElement(`[data-partner-element="${DOM_CONFIG2.elements.form}"]`, this.wrap);
      if (!root)
        return {};
      const getVal = (name) => root.querySelector(`[name="${name}"]`)?.value?.trim();
      const getRadio = (name) => root.querySelector(`input[name="${name}"]:checked`)?.value;
      const getCheckbox = (name) => !!root.querySelector(`[name="${name}"]`)?.checked;
      const form = {};
      ...
      if (vuln === "Yes" || vuln === "No")
        form.Vulnerable = vuln;
      for (const key of this.MARKETING_FIELDS) {
        const el = root.querySelector(`[name="${key}"]`);
        if (el)
          form[key] = getCheckbox(key);
      }
      return form;
    }
    validateForm(e) {
      const errors = [];
      for (const k of ["FirstName", "Surname", "Email", "Mobile"]) {
    ...
    async getDates() {
      ...
      const list = queryElement(`[data-partner-element="${DOM_CONFIG2.elements.dateList}"]`, this.wrap);
      const tpl = queryElement(".mct_pill_field.is-date", this.wrap);
      if (!list)
        return;
      list.innerHTML = "";
    ...
    setupNavButtons() {
      let nextButtons = queryElements(`[data-partner-element="${DOM_CONFIG2.elements.next}"]`, this.wrap);
      let prevButtons = queryElements(`[data-partner-element="${DOM_CONFIG2.elements.prev}"]`, this.wrap);
    ...
    initICID() {
      ...
      const attr16 = this.readICIDFromBody();
      if (attr16) {
        this.setICID(attr16);
        return;
      }
    ...
    setICID(icid) {
      stateManager2.setICID(icid);
    }
    getICID() {
      return stateManager2.getICID();
    }
    setLCID(lcid) {
      stateManager2.setLCID(lcid);
    }
    getLCID() {
      return stateManager2.getLCID();
    }
    formatDateParts(isoLike) {
      if (!isoLike)
        return null;
      let d = null;
    ...
    updateAppointmentTag(booking) {
      ...
      if (!tag)
        return;
      const dayEl = tag.querySelector('[data-partner-element="day-string"]');
      const dateEl = tag.querySelector('[data-partner-element="date-string"]');
      const monthEl = tag.querySelector('[data-partner-element="month-string"]');
      const startEl = tag.querySelector('[data-partner-element="start-time"]');
      const endEl = tag.querySelector('[data-partner-element="end-time"]');
      ...
      if (parts) {
        if (dayEl)
          dayEl.textContent = parts.dayStr;
        if (dateEl)
          dateEl.textContent = parts.dateStr;
        if (monthEl)
          monthEl.textContent = parts.monthStr;
      }
      if (startEl)
        startEl.textContent = fmtTime(booking.bookingStart);
      if (endEl)
        endEl.textContent = fmtTime(booking.bookingEnd);
    }
    async handleFormSubmission() {
      const formBits = this.readEnquiryFormFromDOM();
      const prev = stateManager2.getState().booking;
      const booking = {
