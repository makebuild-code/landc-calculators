...
(() => {
  ...
  var isStaging = window.location.host.includes(".webflow.io");
  ...
  var attr = "data-mini";
  var API_ENDPOINT = "https://landc-website.azurewebsites.net/api/productshttptrigger";
  ...
  var dialogs = () => {
    const attr6 = "data-dialog";
    const components2 = queryElements(`[${attr6}="component"]`);
    console.log(components2);
    components2.forEach((component) => {
      const open = queryElement(`[${attr6}="open"]`, component);
      const dialog = queryElement("dialog", component);
      const close = queryElement(`[${attr6}="close"]`, component);
  ...
  var attr2 = "data-bb";
  var API_ENDPOINT2 = "https://landc-website.azurewebsites.net/api/productshttptrigger";
  ...
  var bestbuys = () => {
    const attr6 = "data-bb";
    const components2 = queryElements(`[${attr6}]`);
    components2.forEach((component) => {
  ...
  var attr5 = "data-calc";
  var API_ENDPOINT3 = "https://landc-website.azurewebsites.net/api/calculatorhttptrigger";
