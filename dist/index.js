...
(() => {
  ...
  var getBaseURLForAPI = () => {
    ...
    if (apiParam)
      return ENDPOINTS2[apiParam] || ENDPOINTS2.prod;
  ...
  var dialogs = () => {
    const attr9 = "data-dialog";
    const components2 = queryElements(`[${attr9}="component"]`);
    components2.forEach((component) => {
      const open = queryElement(`[${attr9}="open"]`, component);
      const dialog = queryElement("dialog", component);
      const close = queryElement(`[${attr9}="close"]`, component);
  ...
  var bestbuys = () => {
    const attr9 = "data-bb";
    const components2 = queryElements(`[${attr9}]`);
    components2.forEach((component) => {
  ...
  var calculators = () => {
    ...
    if (repaymentValueSlider)
      repaymentValueSlider.setAttribute(`${attr9}-output`, "BorrowingAmountHigher");
    if (depositAmountSlider)
      depositAmountSlider.setAttribute(`${attr9}-output`, "DepositAmount");
    if (rateSlider)
      rateSlider.setAttribute(`${attr9}-output`, "InitialRate");
    const components2 = queryElements(`[${attr9}]`);
    components2.forEach((component) => {
  ...
  var MainFormManager = class extends FormManager {
    ...
    constructor(component) {
      ...
      this.components = {
        ...
        wrapper: queryElement(`[${attr7.components}="wrapper"]`, component),
        scroll: queryElement(`[${attr7.components}="scroll"]`, component),
        nextButton: queryElement(`[${attr7.components}="next"]`, component),
  ...
  var Result = class {
    ...
    constructor(wrapper, options) {
      ...
      this.outputs = queryElements(`[${attr8.output}]`, this.template);
      this.button = queryElement(`[${attr8.element}="template-cta"]`, this.template);
      this.init();
    }
    init() {
      this.populate();
    ...
    populate() {
      this.outputs.forEach((output) => {
        const outputName = output.getAttribute(attr8.output);
  ...
  var ResultsManager = class {
    ...
    constructor(component) {
      ...
      this.appointmentDialogButton = queryElement(
        `[${attr8.components}="book-an-appointment"]`,
        this.header
      );
      this.appointmentDialog = queryElement(
        `[${attr8.components}="appointment-dialog"]`,
        this.component
      );
      this.appointmentDialogClose = queryElement(
        `[${attr8.components}="close-appointment-dialog"]`,
        this.appointmentDialog
      );
      this.getFreeAdvice = queryElement(`[${attr8.components}="get-free-advice"]`, this.appointmentDialog);
      this.getFreeAdviceButton = queryElement("button", this.getFreeAdvice);
      this.getADecision = queryElement(`[${attr8.components}="get-a-decision"]`, this.appointmentDialog);
      this.getADecisionButton = queryElement("button", this.getADecision);
      this.applyDirect = queryElement(`[${attr8.components}="apply-direct"]`, this.appointmentDialog);
      this.applyDirectLink = queryElement("a", this.applyDirect);
      this.resultsList = queryElement(`[${attr8.components}="list"]`, this.component);
      this.resultsTemplate = queryElement(`[${attr8.components}="template"]`, this.component);
      this.resultsTemplate.remove();
      this.loader = queryElement(`[${attr8.components}="loader"]`, this.component);
      this.empty = queryElement(`[${attr8.components}="empty"]`, this.component);
      this.pagination = queryElement(`[${attr8.components}="pagination"]`, this.component);
    ...
    initFilterGroups() {
      const filterEls = queryElements(`[${attr8.components}="filter-group"]`, this.component);
    ...
    renderOutputs() {
      ...
      this.outputs.forEach((output) => {
        ...
        const type = output.getAttribute(attr8.type);
        if (key === "LTV") {
