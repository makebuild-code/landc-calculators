...
(() => {
  ...
  var VERSION, attr15, eventBus, isFirstStage, stageManagers, newStageManagers, dom, stateManager, calculationManager, visibilityManager, questionRegistry, MCTManager;
      ...
      MCTManager = {
        ...
        initStages() {
          ...
          if (appointment) {
            ...
            stageManagers["appointment" /* Appointment */] = appointmentManager;
          }
        },
        getComponentDOM() {
          if (!dom.component)
