...
(() => {
  ...
  var FirstTimeBuyerENUM, RepaymentTypeENUM, ResiBtlENUM, ReadinessToBuyENUM, PurchRemoENUM, CreditImpairedENUM;
  ...
  var AppointmentManager = class {
    ...
    getStateData() {
      ...
      const stateData = {
        ...
        Lender: this.getStringAnswer(answers, "Lender" /* Lender */),
        ReadinessToBuy: getEnumValue(ReadinessToBuyENUM, this.getStringAnswer(answers, "ReadinessToBuy" /* ReadinessToBuy */)),
        PurchRemo: getEnumValue(PurchRemoENUM, this.getStringAnswer(answers, "PurchRemo" /* PurchRemo */)),
        ...
        CreditImpaired: getEnumValue(CreditImpairedENUM, this.getStringAnswer(answers, "CreditImpaired" /* CreditImpaired */)),
        ...
        FTB: this.getBooleanAnswer(answers, "FTB" /* FTB */),
        NewBuild: this.getBooleanAnswer(answers, "NewBuild" /* NewBuild */),
        DatePlanToRemo: this.getStringAnswer(answers, "DatePlanToRemo" /* DatePlanToRemo */),
        ChosenMCTProduct: MCTManager.getProduct()
      };
      return stateData;
    }
    // /**
  ...
  // src/mct/shared/MCTManager.ts
  init_types();
  var VERSION = "\u{1F504} MCT DIST v25";
