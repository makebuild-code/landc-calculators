...
(() => {
  ...
  var init_Products = __esm({
    "src/mct/shared/types/api/Products.ts"() {
      ...
      SapValueENUM = /* @__PURE__ */ ((SapValueENUM2) => {
        SapValueENUM2[SapValueENUM2["Yes"] = 100] = "Yes";
        SapValueENUM2[SapValueENUM2["No"] = 80] = "No";
        return SapValueENUM2;
      })(SapValueENUM || {});
    }
  });
  ...
  var generateProductsAPIInput = (options = {}) => {
    ...
    const SapValue = options.SapValue ?? FILTERS_CONFIG.SapValue === getEnumKey(SapValueENUM, 80 /* No */) ? 80 /* No */ : 100 /* Yes */;
    const Features = {};
  ...
  // src/mct/shared/utils/common/getInputValueAsLandC.ts
  init_live_reload();
  init_types();
