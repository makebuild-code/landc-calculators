...
(() => {
  ...
  var EndOfTermENUM, RemoChangeENUM;
  var init_base = __esm({
    "src/mct/shared/types/api/base.ts"() {
      "use strict";
      init_live_reload();
      EndOfTermENUM = /* @__PURE__ */ ((EndOfTermENUM2) => {
        EndOfTermENUM2["WithinThreeMonths"] = "1";
        EndOfTermENUM2["ThreeToSixMonths"] = "2";
        EndOfTermENUM2["SixToTwelveMonths"] = "3";
        EndOfTermENUM2["TwelvePlusMonths"] = "4";
        return EndOfTermENUM2;
      })(EndOfTermENUM || {});
  ...
  var FirstTimeBuyerENUM, RepaymentTypeENUM, ResiBtlENUM, OfferAcceptedENUM, ReadinessToBuyENUM, PurchRemoENUM, CreditImpairedENUM;
  var init_CreateLeadAndBooking = __esm({
    "src/mct/shared/types/api/CreateLeadAndBooking.ts"() {
      ...
      OfferAcceptedENUM = /* @__PURE__ */ ((OfferAcceptedENUM3) => {
        OfferAcceptedENUM3["Yes"] = "Y";
        OfferAcceptedENUM3["No"] = "N";
        return OfferAcceptedENUM3;
      })(OfferAcceptedENUM || {});
  ...
  var init_common = __esm({
    "src/mct/shared/types/common.ts"() {
      "use strict";
      init_live_reload();
      BuyerTypeENUM2 = /* @__PURE__ */ ((BuyerTypeENUM3) => {
        BuyerTypeENUM3["ResidentialPurchase"] = "Residential purchase";
        BuyerTypeENUM3["FtbResidentialPurchase"] = "First Time Buyer";
        BuyerTypeENUM3["BtlPurchase"] = "Buy-to-let purchase";
        BuyerTypeENUM3["ResidentialRemortgage"] = "Residential remortgage";
        BuyerTypeENUM3["BtlRemortgage"] = "Buy-to-let remortgage";
        return BuyerTypeENUM3;
      })(BuyerTypeENUM2 || {});
    }
  });
  ...
  var init_state = __esm({
    "src/mct/shared/types/state.ts"() {
      ...
      CalculationKeysENUM = ((CalculationKeysENUM2) => {
        ...
        CalculationKeysENUM2["RepaymentValue"] = "RepaymentValue" /* RepaymentValue */;
        CalculationKeysENUM2["InterestOnlyValue"] = "InterestOnlyValue" /* InterestOnlyValue */;
  ...
  // src/mct/shared/config/storage.ts
  var STORAGE_CONFIG;
  ...
  // src/mct/shared/components/base/InputGroupBase.ts
  init_live_reload();
  ...
  var ResultsManager = class {
    ...
    saveFilterValues() {
      this.filters.forEach((filter) => {
        ...
        if (key && value !== null && value !== void 0 && name)
  ...
  var AppointmentManager = class {
    ...
    getStateData() {
      try {
        ...
        const stateData = {
          ...
          MaximumBudget: this.getNumericAnswer(answers, "MaximumBudget"),
          // unsure
          BuyerType: getEnumValue(BuyerTypeENUM2, this.getStringAnswer(answers, "BuyerType")),
          // unsure
          ...
          LTV: this.getNumericAnswer(answers, "LTV"),
          // get from calculations
          Source: this.getStringAnswer(answers, "Source"),
          // unsure
          SourceId: this.getNumericAnswer(answers, "SourceId"),
          // unsure
    ...
    getAppointmentData() {
      try {
        ...
        const startTime = formatToHHMM(timeParts[0]);
        const endTime = formatToHHMM(timeParts[1]);
        const booking = {
          source: "SYSTEM",
          // unsure
          bookingDate: date,
  ...
  var CalculationManager = class {
    constructor(stateManager2) {
      ...
      this.calculateIsProceedable = (answers) => {
        ...
        if (PurchRemo === getEnumKey(PurchRemoENUM, "P" /* Purchase */)) {
          ...
          if (!EndOfTerm || EndOfTerm === getEnumKey(EndOfTermENUM, "4" /* TwelvePlusMonths */)) {
            isProceedable = false;
          }
        }
        return {
    ...
    setupCalculationRules() {
      ...
      this.calculationRules.set("EndOfTerm" /* EndOfTerm */, this.endOfTerm);
