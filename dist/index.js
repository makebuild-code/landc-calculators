...
(() => {
  ...
  var init_state = __esm({
    "src/mct/shared/types/state.ts"() {
      ...
      CalculationKeysENUM = ((CalculationKeysENUM3) => {
        ...
        CalculationKeysENUM3["RepaymentValue"] = "RepaymentValue" /* RepaymentValue */;
        CalculationKeysENUM3["InterestOnlyValue"] = "InterestOnlyValue" /* InterestOnlyValue */;
  ...
  var generateProductsAPIInput = (options = {}) => {
    ...
    const RepaymentValue = PurchRemo === "P" /* Purchase */ ? PropertyValue - answers["DepositAmount" /* DepositAmount */] : answers.RepaymentValue;
    ...
    const InterestOnlyValue = answers.InterestOnlyValue ?? 0;
  ...
  var ResultsManager = class {
    ...
    renderOutputs() {
      ...
      this.outputs.forEach((output) => {
        ...
        if (key === "LTV") {
          ...
          const mortgageAmount = calculations["RepaymentValue" /* RepaymentValue */];
          if (!mortgageAmount)
            return;
          if (type === "currency")
    ...
    async handleDirectToBroker() {
      ...
      if (RepaymentValue)
        params.LoanAmount = calculations["RepaymentValue" /* RepaymentValue */]?.toString() || "";
      if (MortgageLength)
  ...
  var AppointmentManager = class {
    ...
    getStateData() {
      ...
      const stateData = {
        ...
        LoanAmount: this.getNumericAnswer(answers, "RepaymentValue" /* RepaymentValue */),
  ...
  var CalculationManager = class {
    ...
    setupCalculationRules() {
      ...
      this.calculationRules.set("RepaymentValue" /* RepaymentValue */, this.repaymentValue);
    }
  ...
  var VisibilityManager = class {
    ...
    getVariableValue(variable) {
      ...
      else if (variable in calculations)
