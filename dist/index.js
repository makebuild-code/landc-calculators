  ...
  var ResultsManager = class {
    ...
    renderOutputs() {
      ...
      this.outputs.forEach((output) => {
        ...
        if (key === "LTV") {
          const propertyValue = MCTManager.getAnswer("PropertyValue" /* PropertyValue */);
          const depositAmount = MCTManager.getAnswer("DepositAmount" /* DepositAmount */);
  ...
  var CalculationManager = class {
    constructor(stateManager2) {
      ...
      this.calculateIsProceedable = (answers) => {
        ...
        if (ReadinessToBuyValue === "R" /* Researching */ || ReadinessToBuyValue === "V" /* Viewing */)
          isProceedable = false;
        if (CreditImpairedValue === "Y" /* Yes */)
          isProceedable = false;
        if (EndOfTermValue === "4" /* TwelvePlusMonths */)
          isProceedable = false;
        return {
