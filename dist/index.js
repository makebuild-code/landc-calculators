...
(() => {
  ...
  var generateProductsAPIInput = (options = {}) => {
    ...
    const SortColumn = options.sortColumn ?? 1 /* Rate */;
    ...
    const NewBuild = SchemePurpose === 2 /* Remortgage */ ? void 0 : answers.NewBuild === "true" ? true : answers.NewBuild === "false" ? false : options.NewBuild ?? FILTERS_CONFIG.NewBuild === "true" ? true : false;
    const Features = {};
    ...
    constructor(stateManager2) {
      ...
      this.calculateIsProceedable = (answers) => {
        ...
        if (PurchRemo === getEnumKey(PurchRemoENUM, "P" /* Purchase */)) {
          ...
          if (!EndOfTerm || EndOfTerm === getEnumKey(DatePlanToRemoENUM, "Over 12 months" /* TwelvePlusMonths */)) {
            isProceedable = false;
          }
        }
        return {
