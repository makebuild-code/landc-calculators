...
(() => {
  ...
  var ResultsManager = class {
    ...
    renderOutputs() {
      ...
      this.outputs.forEach((output) => {
        ...
        if (key === "LTV") {
          ...
          const mortgageAmount = calculations["BorrowAmount" /* BorrowAmount */];
          if (!mortgageAmount)
            return;
          if (type === "currency")
    ...
    async handleDirectToBroker() {
      ...
      if (RepaymentValue)
        params.LoanAmount = calculations["BorrowAmount" /* BorrowAmount */]?.toString() || "";
      if (MortgageLength)
  ...
  var CalculationManager = class {
    constructor(stateManager2) {
      ...
      this.calculateLoanToValue = (answers) => {
        ...
        } else if (PurchRemo === getEnumKey(PurchRemoENUM, "R" /* Remortgage */) && RepaymentValue) {
    ...
    setupCalculationRules() {
      ...
      this.calculationRules.set("DatePlanToRemo" /* DatePlanToRemo */, this.endOfTerm);
      ...
      this.calculationRules.set("BorrowAmount" /* BorrowAmount */, this.repaymentValue);
    }
